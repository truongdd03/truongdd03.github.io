(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const r of document.querySelectorAll('link[rel="modulepreload"]'))i(r);new MutationObserver(r=>{for(const s of r)if(s.type==="childList")for(const o of s.addedNodes)o.tagName==="LINK"&&o.rel==="modulepreload"&&i(o)}).observe(document,{childList:!0,subtree:!0});function n(r){const s={};return r.integrity&&(s.integrity=r.integrity),r.referrerpolicy&&(s.referrerPolicy=r.referrerpolicy),r.crossorigin==="use-credentials"?s.credentials="include":r.crossorigin==="anonymous"?s.credentials="omit":s.credentials="same-origin",s}function i(r){if(r.ep)return;r.ep=!0;const s=n(r);fetch(r.href,s)}})();function Ja(t,e){const n=Object.create(null),i=t.split(",");for(let r=0;r<i.length;r++)n[i[r]]=!0;return e?r=>!!n[r.toLowerCase()]:r=>!!n[r]}const pg="itemscope,allowfullscreen,formnovalidate,ismap,nomodule,novalidate,readonly",mg=Ja(pg);function ad(t){return!!t||t===""}function ar(t){if(W(t)){const e={};for(let n=0;n<t.length;n++){const i=t[n],r=Fe(i)?vg(i):ar(i);if(r)for(const s in r)e[s]=r[s]}return e}else{if(Fe(t))return t;if(Ie(t))return t}}const gg=/;(?![^(]*\))/g,_g=/:(.+)/;function vg(t){const e={};return t.split(gg).forEach(n=>{if(n){const i=n.split(_g);i.length>1&&(e[i[0].trim()]=i[1].trim())}}),e}function qe(t){let e="";if(Fe(t))e=t;else if(W(t))for(let n=0;n<t.length;n++){const i=qe(t[n]);i&&(e+=i+" ")}else if(Ie(t))for(const n in t)t[n]&&(e+=n+" ");return e.trim()}const Je=t=>Fe(t)?t:t==null?"":W(t)||Ie(t)&&(t.toString===fd||!K(t.toString))?JSON.stringify(t,ld,2):String(t),ld=(t,e)=>e&&e.__v_isRef?ld(t,e.value):mi(e)?{[`Map(${e.size})`]:[...e.entries()].reduce((n,[i,r])=>(n[`${i} =>`]=r,n),{})}:cd(e)?{[`Set(${e.size})`]:[...e.values()]}:Ie(e)&&!W(e)&&!dd(e)?String(e):e,ve={},pi=[],St=()=>{},yg=()=>!1,bg=/^on[^a-z]/,Vs=t=>bg.test(t),Za=t=>t.startsWith("onUpdate:"),We=Object.assign,el=(t,e)=>{const n=t.indexOf(e);n>-1&&t.splice(n,1)},wg=Object.prototype.hasOwnProperty,ie=(t,e)=>wg.call(t,e),W=Array.isArray,mi=t=>qs(t)==="[object Map]",cd=t=>qs(t)==="[object Set]",K=t=>typeof t=="function",Fe=t=>typeof t=="string",tl=t=>typeof t=="symbol",Ie=t=>t!==null&&typeof t=="object",ud=t=>Ie(t)&&K(t.then)&&K(t.catch),fd=Object.prototype.toString,qs=t=>fd.call(t),Eg=t=>qs(t).slice(8,-1),dd=t=>qs(t)==="[object Object]",nl=t=>Fe(t)&&t!=="NaN"&&t[0]!=="-"&&""+parseInt(t,10)===t,ls=Ja(",key,ref,ref_for,ref_key,onVnodeBeforeMount,onVnodeMounted,onVnodeBeforeUpdate,onVnodeUpdated,onVnodeBeforeUnmount,onVnodeUnmounted"),Gs=t=>{const e=Object.create(null);return n=>e[n]||(e[n]=t(n))},Cg=/-(\w)/g,Bt=Gs(t=>t.replace(Cg,(e,n)=>n?n.toUpperCase():"")),xg=/\B([A-Z])/g,Ri=Gs(t=>t.replace(xg,"-$1").toLowerCase()),Ys=Gs(t=>t.charAt(0).toUpperCase()+t.slice(1)),To=Gs(t=>t?`on${Ys(t)}`:""),lr=(t,e)=>!Object.is(t,e),So=(t,e)=>{for(let n=0;n<t.length;n++)t[n](e)},hs=(t,e,n)=>{Object.defineProperty(t,e,{configurable:!0,enumerable:!1,value:n})},hd=t=>{const e=parseFloat(t);return isNaN(e)?t:e};let Rc;const Ig=()=>Rc||(Rc=typeof globalThis<"u"?globalThis:typeof self<"u"?self:typeof window<"u"?window:typeof global<"u"?global:{});let lt;class Tg{constructor(e=!1){this.active=!0,this.effects=[],this.cleanups=[],!e&&lt&&(this.parent=lt,this.index=(lt.scopes||(lt.scopes=[])).push(this)-1)}run(e){if(this.active){const n=lt;try{return lt=this,e()}finally{lt=n}}}on(){lt=this}off(){lt=this.parent}stop(e){if(this.active){let n,i;for(n=0,i=this.effects.length;n<i;n++)this.effects[n].stop();for(n=0,i=this.cleanups.length;n<i;n++)this.cleanups[n]();if(this.scopes)for(n=0,i=this.scopes.length;n<i;n++)this.scopes[n].stop(!0);if(this.parent&&!e){const r=this.parent.scopes.pop();r&&r!==this&&(this.parent.scopes[this.index]=r,r.index=this.index)}this.active=!1}}}function Sg(t,e=lt){e&&e.active&&e.effects.push(t)}function Ag(){return lt}function kg(t){lt&&lt.cleanups.push(t)}const il=t=>{const e=new Set(t);return e.w=0,e.n=0,e},pd=t=>(t.w&yn)>0,md=t=>(t.n&yn)>0,Ng=({deps:t})=>{if(t.length)for(let e=0;e<t.length;e++)t[e].w|=yn},Rg=t=>{const{deps:e}=t;if(e.length){let n=0;for(let i=0;i<e.length;i++){const r=e[i];pd(r)&&!md(r)?r.delete(t):e[n++]=r,r.w&=~yn,r.n&=~yn}e.length=n}},ia=new WeakMap;let Gi=0,yn=1;const ra=30;let bt;const Vn=Symbol(""),sa=Symbol("");class rl{constructor(e,n=null,i){this.fn=e,this.scheduler=n,this.active=!0,this.deps=[],this.parent=void 0,Sg(this,i)}run(){if(!this.active)return this.fn();let e=bt,n=hn;for(;e;){if(e===this)return;e=e.parent}try{return this.parent=bt,bt=this,hn=!0,yn=1<<++Gi,Gi<=ra?Ng(this):Oc(this),this.fn()}finally{Gi<=ra&&Rg(this),yn=1<<--Gi,bt=this.parent,hn=n,this.parent=void 0,this.deferStop&&this.stop()}}stop(){bt===this?this.deferStop=!0:this.active&&(Oc(this),this.onStop&&this.onStop(),this.active=!1)}}function Oc(t){const{deps:e}=t;if(e.length){for(let n=0;n<e.length;n++)e[n].delete(t);e.length=0}}let hn=!0;const gd=[];function Oi(){gd.push(hn),hn=!1}function Pi(){const t=gd.pop();hn=t===void 0?!0:t}function ut(t,e,n){if(hn&&bt){let i=ia.get(t);i||ia.set(t,i=new Map);let r=i.get(n);r||i.set(n,r=il()),_d(r)}}function _d(t,e){let n=!1;Gi<=ra?md(t)||(t.n|=yn,n=!pd(t)):n=!t.has(bt),n&&(t.add(bt),bt.deps.push(t))}function Gt(t,e,n,i,r,s){const o=ia.get(t);if(!o)return;let a=[];if(e==="clear")a=[...o.values()];else if(n==="length"&&W(t))o.forEach((l,c)=>{(c==="length"||c>=i)&&a.push(l)});else switch(n!==void 0&&a.push(o.get(n)),e){case"add":W(t)?nl(n)&&a.push(o.get("length")):(a.push(o.get(Vn)),mi(t)&&a.push(o.get(sa)));break;case"delete":W(t)||(a.push(o.get(Vn)),mi(t)&&a.push(o.get(sa)));break;case"set":mi(t)&&a.push(o.get(Vn));break}if(a.length===1)a[0]&&oa(a[0]);else{const l=[];for(const c of a)c&&l.push(...c);oa(il(l))}}function oa(t,e){const n=W(t)?t:[...t];for(const i of n)i.computed&&Pc(i);for(const i of n)i.computed||Pc(i)}function Pc(t,e){(t!==bt||t.allowRecurse)&&(t.scheduler?t.scheduler():t.run())}const Og=Ja("__proto__,__v_isRef,__isVue"),vd=new Set(Object.getOwnPropertyNames(Symbol).filter(t=>t!=="arguments"&&t!=="caller").map(t=>Symbol[t]).filter(tl)),Pg=sl(),Mg=sl(!1,!0),Dg=sl(!0),Mc=Lg();function Lg(){const t={};return["includes","indexOf","lastIndexOf"].forEach(e=>{t[e]=function(...n){const i=oe(this);for(let s=0,o=this.length;s<o;s++)ut(i,"get",s+"");const r=i[e](...n);return r===-1||r===!1?i[e](...n.map(oe)):r}}),["push","pop","shift","unshift","splice"].forEach(e=>{t[e]=function(...n){Oi();const i=oe(this)[e].apply(this,n);return Pi(),i}}),t}function sl(t=!1,e=!1){return function(i,r,s){if(r==="__v_isReactive")return!t;if(r==="__v_isReadonly")return t;if(r==="__v_isShallow")return e;if(r==="__v_raw"&&s===(t?e?Jg:Cd:e?Ed:wd).get(i))return i;const o=W(i);if(!t&&o&&ie(Mc,r))return Reflect.get(Mc,r,s);const a=Reflect.get(i,r,s);return(tl(r)?vd.has(r):Og(r))||(t||ut(i,"get",r),e)?a:Re(a)?o&&nl(r)?a:a.value:Ie(a)?t?xd(a):Mi(a):a}}const Fg=yd(),$g=yd(!0);function yd(t=!1){return function(n,i,r,s){let o=n[i];if(Ei(o)&&Re(o)&&!Re(r))return!1;if(!t&&(!ps(r)&&!Ei(r)&&(o=oe(o),r=oe(r)),!W(n)&&Re(o)&&!Re(r)))return o.value=r,!0;const a=W(n)&&nl(i)?Number(i)<n.length:ie(n,i),l=Reflect.set(n,i,r,s);return n===oe(s)&&(a?lr(r,o)&&Gt(n,"set",i,r):Gt(n,"add",i,r)),l}}function Bg(t,e){const n=ie(t,e);t[e];const i=Reflect.deleteProperty(t,e);return i&&n&&Gt(t,"delete",e,void 0),i}function Hg(t,e){const n=Reflect.has(t,e);return(!tl(e)||!vd.has(e))&&ut(t,"has",e),n}function jg(t){return ut(t,"iterate",W(t)?"length":Vn),Reflect.ownKeys(t)}const bd={get:Pg,set:Fg,deleteProperty:Bg,has:Hg,ownKeys:jg},Ug={get:Dg,set(t,e){return!0},deleteProperty(t,e){return!0}},zg=We({},bd,{get:Mg,set:$g}),ol=t=>t,Ks=t=>Reflect.getPrototypeOf(t);function Wr(t,e,n=!1,i=!1){t=t.__v_raw;const r=oe(t),s=oe(e);n||(e!==s&&ut(r,"get",e),ut(r,"get",s));const{has:o}=Ks(r),a=i?ol:n?cl:cr;if(o.call(r,e))return a(t.get(e));if(o.call(r,s))return a(t.get(s));t!==r&&t.get(e)}function Vr(t,e=!1){const n=this.__v_raw,i=oe(n),r=oe(t);return e||(t!==r&&ut(i,"has",t),ut(i,"has",r)),t===r?n.has(t):n.has(t)||n.has(r)}function qr(t,e=!1){return t=t.__v_raw,!e&&ut(oe(t),"iterate",Vn),Reflect.get(t,"size",t)}function Dc(t){t=oe(t);const e=oe(this);return Ks(e).has.call(e,t)||(e.add(t),Gt(e,"add",t,t)),this}function Lc(t,e){e=oe(e);const n=oe(this),{has:i,get:r}=Ks(n);let s=i.call(n,t);s||(t=oe(t),s=i.call(n,t));const o=r.call(n,t);return n.set(t,e),s?lr(e,o)&&Gt(n,"set",t,e):Gt(n,"add",t,e),this}function Fc(t){const e=oe(this),{has:n,get:i}=Ks(e);let r=n.call(e,t);r||(t=oe(t),r=n.call(e,t)),i&&i.call(e,t);const s=e.delete(t);return r&&Gt(e,"delete",t,void 0),s}function $c(){const t=oe(this),e=t.size!==0,n=t.clear();return e&&Gt(t,"clear",void 0,void 0),n}function Gr(t,e){return function(i,r){const s=this,o=s.__v_raw,a=oe(o),l=e?ol:t?cl:cr;return!t&&ut(a,"iterate",Vn),o.forEach((c,u)=>i.call(r,l(c),l(u),s))}}function Yr(t,e,n){return function(...i){const r=this.__v_raw,s=oe(r),o=mi(s),a=t==="entries"||t===Symbol.iterator&&o,l=t==="keys"&&o,c=r[t](...i),u=n?ol:e?cl:cr;return!e&&ut(s,"iterate",l?sa:Vn),{next(){const{value:f,done:d}=c.next();return d?{value:f,done:d}:{value:a?[u(f[0]),u(f[1])]:u(f),done:d}},[Symbol.iterator](){return this}}}}function on(t){return function(...e){return t==="delete"?!1:this}}function Wg(){const t={get(s){return Wr(this,s)},get size(){return qr(this)},has:Vr,add:Dc,set:Lc,delete:Fc,clear:$c,forEach:Gr(!1,!1)},e={get(s){return Wr(this,s,!1,!0)},get size(){return qr(this)},has:Vr,add:Dc,set:Lc,delete:Fc,clear:$c,forEach:Gr(!1,!0)},n={get(s){return Wr(this,s,!0)},get size(){return qr(this,!0)},has(s){return Vr.call(this,s,!0)},add:on("add"),set:on("set"),delete:on("delete"),clear:on("clear"),forEach:Gr(!0,!1)},i={get(s){return Wr(this,s,!0,!0)},get size(){return qr(this,!0)},has(s){return Vr.call(this,s,!0)},add:on("add"),set:on("set"),delete:on("delete"),clear:on("clear"),forEach:Gr(!0,!0)};return["keys","values","entries",Symbol.iterator].forEach(s=>{t[s]=Yr(s,!1,!1),n[s]=Yr(s,!0,!1),e[s]=Yr(s,!1,!0),i[s]=Yr(s,!0,!0)}),[t,n,e,i]}const[Vg,qg,Gg,Yg]=Wg();function al(t,e){const n=e?t?Yg:Gg:t?qg:Vg;return(i,r,s)=>r==="__v_isReactive"?!t:r==="__v_isReadonly"?t:r==="__v_raw"?i:Reflect.get(ie(n,r)&&r in i?n:i,r,s)}const Kg={get:al(!1,!1)},Qg={get:al(!1,!0)},Xg={get:al(!0,!1)},wd=new WeakMap,Ed=new WeakMap,Cd=new WeakMap,Jg=new WeakMap;function Zg(t){switch(t){case"Object":case"Array":return 1;case"Map":case"Set":case"WeakMap":case"WeakSet":return 2;default:return 0}}function e_(t){return t.__v_skip||!Object.isExtensible(t)?0:Zg(Eg(t))}function Mi(t){return Ei(t)?t:ll(t,!1,bd,Kg,wd)}function t_(t){return ll(t,!1,zg,Qg,Ed)}function xd(t){return ll(t,!0,Ug,Xg,Cd)}function ll(t,e,n,i,r){if(!Ie(t)||t.__v_raw&&!(e&&t.__v_isReactive))return t;const s=r.get(t);if(s)return s;const o=e_(t);if(o===0)return t;const a=new Proxy(t,o===2?i:n);return r.set(t,a),a}function gi(t){return Ei(t)?gi(t.__v_raw):!!(t&&t.__v_isReactive)}function Ei(t){return!!(t&&t.__v_isReadonly)}function ps(t){return!!(t&&t.__v_isShallow)}function Id(t){return gi(t)||Ei(t)}function oe(t){const e=t&&t.__v_raw;return e?oe(e):t}function Td(t){return hs(t,"__v_skip",!0),t}const cr=t=>Ie(t)?Mi(t):t,cl=t=>Ie(t)?xd(t):t;function Sd(t){hn&&bt&&(t=oe(t),_d(t.dep||(t.dep=il())))}function Ad(t,e){t=oe(t),t.dep&&oa(t.dep)}function Re(t){return!!(t&&t.__v_isRef===!0)}function Dt(t){return kd(t,!1)}function n_(t){return kd(t,!0)}function kd(t,e){return Re(t)?t:new i_(t,e)}class i_{constructor(e,n){this.__v_isShallow=n,this.dep=void 0,this.__v_isRef=!0,this._rawValue=n?e:oe(e),this._value=n?e:cr(e)}get value(){return Sd(this),this._value}set value(e){const n=this.__v_isShallow||ps(e)||Ei(e);e=n?e:oe(e),lr(e,this._rawValue)&&(this._rawValue=e,this._value=n?e:cr(e),Ad(this))}}function Oe(t){return Re(t)?t.value:t}const r_={get:(t,e,n)=>Oe(Reflect.get(t,e,n)),set:(t,e,n,i)=>{const r=t[e];return Re(r)&&!Re(n)?(r.value=n,!0):Reflect.set(t,e,n,i)}};function Nd(t){return gi(t)?t:new Proxy(t,r_)}var Rd;class s_{constructor(e,n,i,r){this._setter=n,this.dep=void 0,this.__v_isRef=!0,this[Rd]=!1,this._dirty=!0,this.effect=new rl(e,()=>{this._dirty||(this._dirty=!0,Ad(this))}),this.effect.computed=this,this.effect.active=this._cacheable=!r,this.__v_isReadonly=i}get value(){const e=oe(this);return Sd(e),(e._dirty||!e._cacheable)&&(e._dirty=!1,e._value=e.effect.run()),e._value}set value(e){this._setter(e)}}Rd="__v_isReadonly";function o_(t,e,n=!1){let i,r;const s=K(t);return s?(i=t,r=St):(i=t.get,r=t.set),new s_(i,r,s||!r,n)}function pn(t,e,n,i){let r;try{r=i?t(...i):t()}catch(s){Qs(s,e,n)}return r}function pt(t,e,n,i){if(K(t)){const s=pn(t,e,n,i);return s&&ud(s)&&s.catch(o=>{Qs(o,e,n)}),s}const r=[];for(let s=0;s<t.length;s++)r.push(pt(t[s],e,n,i));return r}function Qs(t,e,n,i=!0){const r=e?e.vnode:null;if(e){let s=e.parent;const o=e.proxy,a=n;for(;s;){const c=s.ec;if(c){for(let u=0;u<c.length;u++)if(c[u](t,o,a)===!1)return}s=s.parent}const l=e.appContext.config.errorHandler;if(l){pn(l,null,10,[t,o,a]);return}}a_(t,n,r,i)}function a_(t,e,n,i=!0){console.error(t)}let ur=!1,aa=!1;const Qe=[];let Mt=0;const _i=[];let zt=null,Fn=0;const Od=Promise.resolve();let ul=null;function Pd(t){const e=ul||Od;return t?e.then(this?t.bind(this):t):e}function l_(t){let e=Mt+1,n=Qe.length;for(;e<n;){const i=e+n>>>1;fr(Qe[i])<t?e=i+1:n=i}return e}function fl(t){(!Qe.length||!Qe.includes(t,ur&&t.allowRecurse?Mt+1:Mt))&&(t.id==null?Qe.push(t):Qe.splice(l_(t.id),0,t),Md())}function Md(){!ur&&!aa&&(aa=!0,ul=Od.then(Ld))}function c_(t){const e=Qe.indexOf(t);e>Mt&&Qe.splice(e,1)}function u_(t){W(t)?_i.push(...t):(!zt||!zt.includes(t,t.allowRecurse?Fn+1:Fn))&&_i.push(t),Md()}function Bc(t,e=ur?Mt+1:0){for(;e<Qe.length;e++){const n=Qe[e];n&&n.pre&&(Qe.splice(e,1),e--,n())}}function Dd(t){if(_i.length){const e=[...new Set(_i)];if(_i.length=0,zt){zt.push(...e);return}for(zt=e,zt.sort((n,i)=>fr(n)-fr(i)),Fn=0;Fn<zt.length;Fn++)zt[Fn]();zt=null,Fn=0}}const fr=t=>t.id==null?1/0:t.id,f_=(t,e)=>{const n=fr(t)-fr(e);if(n===0){if(t.pre&&!e.pre)return-1;if(e.pre&&!t.pre)return 1}return n};function Ld(t){aa=!1,ur=!0,Qe.sort(f_);const e=St;try{for(Mt=0;Mt<Qe.length;Mt++){const n=Qe[Mt];n&&n.active!==!1&&pn(n,null,14)}}finally{Mt=0,Qe.length=0,Dd(),ur=!1,ul=null,(Qe.length||_i.length)&&Ld()}}function d_(t,e,...n){if(t.isUnmounted)return;const i=t.vnode.props||ve;let r=n;const s=e.startsWith("update:"),o=s&&e.slice(7);if(o&&o in i){const u=`${o==="modelValue"?"model":o}Modifiers`,{number:f,trim:d}=i[u]||ve;d&&(r=n.map(p=>p.trim())),f&&(r=n.map(hd))}let a,l=i[a=To(e)]||i[a=To(Bt(e))];!l&&s&&(l=i[a=To(Ri(e))]),l&&pt(l,t,6,r);const c=i[a+"Once"];if(c){if(!t.emitted)t.emitted={};else if(t.emitted[a])return;t.emitted[a]=!0,pt(c,t,6,r)}}function Fd(t,e,n=!1){const i=e.emitsCache,r=i.get(t);if(r!==void 0)return r;const s=t.emits;let o={},a=!1;if(!K(t)){const l=c=>{const u=Fd(c,e,!0);u&&(a=!0,We(o,u))};!n&&e.mixins.length&&e.mixins.forEach(l),t.extends&&l(t.extends),t.mixins&&t.mixins.forEach(l)}return!s&&!a?(Ie(t)&&i.set(t,null),null):(W(s)?s.forEach(l=>o[l]=null):We(o,s),Ie(t)&&i.set(t,o),o)}function Xs(t,e){return!t||!Vs(e)?!1:(e=e.slice(2).replace(/Once$/,""),ie(t,e[0].toLowerCase()+e.slice(1))||ie(t,Ri(e))||ie(t,e))}let Ze=null,Js=null;function ms(t){const e=Ze;return Ze=t,Js=t&&t.type.__scopeId||null,e}function Zs(t){Js=t}function eo(){Js=null}function Ye(t,e=Ze,n){if(!e||t._n)return t;const i=(...r)=>{i._d&&Qc(-1);const s=ms(e),o=t(...r);return ms(s),i._d&&Qc(1),o};return i._n=!0,i._c=!0,i._d=!0,i}function Ao(t){const{type:e,vnode:n,proxy:i,withProxy:r,props:s,propsOptions:[o],slots:a,attrs:l,emit:c,render:u,renderCache:f,data:d,setupState:p,ctx:g,inheritAttrs:b}=t;let I,_;const w=ms(t);try{if(n.shapeFlag&4){const B=r||i;I=Pt(u.call(B,B,f,s,p,d,g)),_=l}else{const B=e;I=Pt(B.length>1?B(s,{attrs:l,slots:a,emit:c}):B(s,null)),_=e.props?l:h_(l)}}catch(B){Qi.length=0,Qs(B,t,1),I=Y(mt)}let O=I;if(_&&b!==!1){const B=Object.keys(_),{shapeFlag:V}=O;B.length&&V&7&&(o&&B.some(Za)&&(_=p_(_,o)),O=wn(O,_))}return n.dirs&&(O=wn(O),O.dirs=O.dirs?O.dirs.concat(n.dirs):n.dirs),n.transition&&(O.transition=n.transition),I=O,ms(w),I}const h_=t=>{let e;for(const n in t)(n==="class"||n==="style"||Vs(n))&&((e||(e={}))[n]=t[n]);return e},p_=(t,e)=>{const n={};for(const i in t)(!Za(i)||!(i.slice(9)in e))&&(n[i]=t[i]);return n};function m_(t,e,n){const{props:i,children:r,component:s}=t,{props:o,children:a,patchFlag:l}=e,c=s.emitsOptions;if(e.dirs||e.transition)return!0;if(n&&l>=0){if(l&1024)return!0;if(l&16)return i?Hc(i,o,c):!!o;if(l&8){const u=e.dynamicProps;for(let f=0;f<u.length;f++){const d=u[f];if(o[d]!==i[d]&&!Xs(c,d))return!0}}}else return(r||a)&&(!a||!a.$stable)?!0:i===o?!1:i?o?Hc(i,o,c):!0:!!o;return!1}function Hc(t,e,n){const i=Object.keys(e);if(i.length!==Object.keys(t).length)return!0;for(let r=0;r<i.length;r++){const s=i[r];if(e[s]!==t[s]&&!Xs(n,s))return!0}return!1}function g_({vnode:t,parent:e},n){for(;e&&e.subTree===t;)(t=e.vnode).el=n,e=e.parent}const __=t=>t.__isSuspense;function v_(t,e){e&&e.pendingBranch?W(t)?e.effects.push(...t):e.effects.push(t):u_(t)}function cs(t,e){if(ze){let n=ze.provides;const i=ze.parent&&ze.parent.provides;i===n&&(n=ze.provides=Object.create(i)),n[t]=e}}function Vt(t,e,n=!1){const i=ze||Ze;if(i){const r=i.parent==null?i.vnode.appContext&&i.vnode.appContext.provides:i.parent.provides;if(r&&t in r)return r[t];if(arguments.length>1)return n&&K(e)?e.call(i.proxy):e}}const jc={};function qn(t,e,n){return $d(t,e,n)}function $d(t,e,{immediate:n,deep:i,flush:r,onTrack:s,onTrigger:o}=ve){const a=ze;let l,c=!1,u=!1;if(Re(t)?(l=()=>t.value,c=ps(t)):gi(t)?(l=()=>t,i=!0):W(t)?(u=!0,c=t.some(_=>gi(_)||ps(_)),l=()=>t.map(_=>{if(Re(_))return _.value;if(gi(_))return ui(_);if(K(_))return pn(_,a,2)})):K(t)?e?l=()=>pn(t,a,2):l=()=>{if(!(a&&a.isUnmounted))return f&&f(),pt(t,a,3,[d])}:l=St,e&&i){const _=l;l=()=>ui(_())}let f,d=_=>{f=I.onStop=()=>{pn(_,a,4)}};if(mr)return d=St,e?n&&pt(e,a,3,[l(),u?[]:void 0,d]):l(),St;let p=u?[]:jc;const g=()=>{if(!!I.active)if(e){const _=I.run();(i||c||(u?_.some((w,O)=>lr(w,p[O])):lr(_,p)))&&(f&&f(),pt(e,a,3,[_,p===jc?void 0:p,d]),p=_)}else I.run()};g.allowRecurse=!!e;let b;r==="sync"?b=g:r==="post"?b=()=>it(g,a&&a.suspense):(g.pre=!0,a&&(g.id=a.uid),b=()=>fl(g));const I=new rl(l,b);return e?n?g():p=I.run():r==="post"?it(I.run.bind(I),a&&a.suspense):I.run(),()=>{I.stop(),a&&a.scope&&el(a.scope.effects,I)}}function y_(t,e,n){const i=this.proxy,r=Fe(t)?t.includes(".")?Bd(i,t):()=>i[t]:t.bind(i,i);let s;K(e)?s=e:(s=e.handler,n=e);const o=ze;Ci(this);const a=$d(r,s.bind(i),n);return o?Ci(o):Gn(),a}function Bd(t,e){const n=e.split(".");return()=>{let i=t;for(let r=0;r<n.length&&i;r++)i=i[n[r]];return i}}function ui(t,e){if(!Ie(t)||t.__v_skip||(e=e||new Set,e.has(t)))return t;if(e.add(t),Re(t))ui(t.value,e);else if(W(t))for(let n=0;n<t.length;n++)ui(t[n],e);else if(cd(t)||mi(t))t.forEach(n=>{ui(n,e)});else if(dd(t))for(const n in t)ui(t[n],e);return t}function Hd(){const t={isMounted:!1,isLeaving:!1,isUnmounting:!1,leavingVNodes:new Map};return hl(()=>{t.isMounted=!0}),Wd(()=>{t.isUnmounting=!0}),t}const dt=[Function,Array],b_={name:"BaseTransition",props:{mode:String,appear:Boolean,persisted:Boolean,onBeforeEnter:dt,onEnter:dt,onAfterEnter:dt,onEnterCancelled:dt,onBeforeLeave:dt,onLeave:dt,onAfterLeave:dt,onLeaveCancelled:dt,onBeforeAppear:dt,onAppear:dt,onAfterAppear:dt,onAppearCancelled:dt},setup(t,{slots:e}){const n=oh(),i=Hd();let r;return()=>{const s=e.default&&dl(e.default(),!0);if(!s||!s.length)return;let o=s[0];if(s.length>1){for(const b of s)if(b.type!==mt){o=b;break}}const a=oe(t),{mode:l}=a;if(i.isLeaving)return ko(o);const c=Uc(o);if(!c)return ko(o);const u=dr(c,a,i,n);hr(c,u);const f=n.subTree,d=f&&Uc(f);let p=!1;const{getTransitionKey:g}=c.type;if(g){const b=g();r===void 0?r=b:b!==r&&(r=b,p=!0)}if(d&&d.type!==mt&&(!$n(c,d)||p)){const b=dr(d,a,i,n);if(hr(d,b),l==="out-in")return i.isLeaving=!0,b.afterLeave=()=>{i.isLeaving=!1,n.update()},ko(o);l==="in-out"&&c.type!==mt&&(b.delayLeave=(I,_,w)=>{const O=jd(i,d);O[String(d.key)]=d,I._leaveCb=()=>{_(),I._leaveCb=void 0,delete u.delayedLeave},u.delayedLeave=w})}return o}}},w_=b_;function jd(t,e){const{leavingVNodes:n}=t;let i=n.get(e.type);return i||(i=Object.create(null),n.set(e.type,i)),i}function dr(t,e,n,i){const{appear:r,mode:s,persisted:o=!1,onBeforeEnter:a,onEnter:l,onAfterEnter:c,onEnterCancelled:u,onBeforeLeave:f,onLeave:d,onAfterLeave:p,onLeaveCancelled:g,onBeforeAppear:b,onAppear:I,onAfterAppear:_,onAppearCancelled:w}=e,O=String(t.key),B=jd(n,t),V=(q,ne)=>{q&&pt(q,i,9,ne)},le=(q,ne)=>{const ae=ne[1];V(q,ne),W(q)?q.every(Me=>Me.length<=1)&&ae():q.length<=1&&ae()},ue={mode:s,persisted:o,beforeEnter(q){let ne=a;if(!n.isMounted)if(r)ne=b||a;else return;q._leaveCb&&q._leaveCb(!0);const ae=B[O];ae&&$n(t,ae)&&ae.el._leaveCb&&ae.el._leaveCb(),V(ne,[q])},enter(q){let ne=l,ae=c,Me=u;if(!n.isMounted)if(r)ne=I||l,ae=_||c,Me=w||u;else return;let L=!1;const be=q._enterCb=Ve=>{L||(L=!0,Ve?V(Me,[q]):V(ae,[q]),ue.delayedLeave&&ue.delayedLeave(),q._enterCb=void 0)};ne?le(ne,[q,be]):be()},leave(q,ne){const ae=String(t.key);if(q._enterCb&&q._enterCb(!0),n.isUnmounting)return ne();V(f,[q]);let Me=!1;const L=q._leaveCb=be=>{Me||(Me=!0,ne(),be?V(g,[q]):V(p,[q]),q._leaveCb=void 0,B[ae]===t&&delete B[ae])};B[ae]=t,d?le(d,[q,L]):L()},clone(q){return dr(q,e,n,i)}};return ue}function ko(t){if(to(t))return t=wn(t),t.children=null,t}function Uc(t){return to(t)?t.children?t.children[0]:void 0:t}function hr(t,e){t.shapeFlag&6&&t.component?hr(t.component.subTree,e):t.shapeFlag&128?(t.ssContent.transition=e.clone(t.ssContent),t.ssFallback.transition=e.clone(t.ssFallback)):t.transition=e}function dl(t,e=!1,n){let i=[],r=0;for(let s=0;s<t.length;s++){let o=t[s];const a=n==null?o.key:String(n)+String(o.key!=null?o.key:s);o.type===je?(o.patchFlag&128&&r++,i=i.concat(dl(o.children,e,a))):(e||o.type!==mt)&&i.push(a!=null?wn(o,{key:a}):o)}if(r>1)for(let s=0;s<i.length;s++)i[s].patchFlag=-2;return i}function Pe(t){return K(t)?{setup:t,name:t.name}:t}const Ki=t=>!!t.type.__asyncLoader,to=t=>t.type.__isKeepAlive;function E_(t,e){Ud(t,"a",e)}function C_(t,e){Ud(t,"da",e)}function Ud(t,e,n=ze){const i=t.__wdc||(t.__wdc=()=>{let r=n;for(;r;){if(r.isDeactivated)return;r=r.parent}return t()});if(no(e,i,n),n){let r=n.parent;for(;r&&r.parent;)to(r.parent.vnode)&&x_(i,e,n,r),r=r.parent}}function x_(t,e,n,i){const r=no(e,t,i,!0);Vd(()=>{el(i[e],r)},n)}function no(t,e,n=ze,i=!1){if(n){const r=n[t]||(n[t]=[]),s=e.__weh||(e.__weh=(...o)=>{if(n.isUnmounted)return;Oi(),Ci(n);const a=pt(e,n,t,o);return Gn(),Pi(),a});return i?r.unshift(s):r.push(s),s}}const en=t=>(e,n=ze)=>(!mr||t==="sp")&&no(t,(...i)=>e(...i),n),I_=en("bm"),hl=en("m"),T_=en("bu"),zd=en("u"),Wd=en("bum"),Vd=en("um"),S_=en("sp"),A_=en("rtg"),k_=en("rtc");function N_(t,e=ze){no("ec",t,e)}function Rn(t,e,n,i){const r=t.dirs,s=e&&e.dirs;for(let o=0;o<r.length;o++){const a=r[o];s&&(a.oldValue=s[o].value);let l=a.dir[i];l&&(Oi(),pt(l,n,8,[t.el,a,t,e]),Pi())}}const pl="components";function Yt(t,e){return Gd(pl,t,!0,e)||t}const qd=Symbol();function R_(t){return Fe(t)?Gd(pl,t,!1)||t:t||qd}function Gd(t,e,n=!0,i=!1){const r=Ze||ze;if(r){const s=r.type;if(t===pl){const a=ov(s,!1);if(a&&(a===e||a===Bt(e)||a===Ys(Bt(e))))return s}const o=zc(r[t]||s[t],e)||zc(r.appContext[t],e);return!o&&i?s:o}}function zc(t,e){return t&&(t[e]||t[Bt(e)]||t[Ys(Bt(e))])}function ml(t,e,n,i){let r;const s=n&&n[i];if(W(t)||Fe(t)){r=new Array(t.length);for(let o=0,a=t.length;o<a;o++)r[o]=e(t[o],o,void 0,s&&s[o])}else if(typeof t=="number"){r=new Array(t);for(let o=0;o<t;o++)r[o]=e(o+1,o,void 0,s&&s[o])}else if(Ie(t))if(t[Symbol.iterator])r=Array.from(t,(o,a)=>e(o,a,void 0,s&&s[a]));else{const o=Object.keys(t);r=new Array(o.length);for(let a=0,l=o.length;a<l;a++){const c=o[a];r[a]=e(t[c],c,a,s&&s[a])}}else r=[];return n&&(n[i]=r),r}function ht(t,e,n={},i,r){if(Ze.isCE||Ze.parent&&Ki(Ze.parent)&&Ze.parent.isCE)return Y("slot",e==="default"?null:{name:e},i&&i());let s=t[e];s&&s._c&&(s._d=!1),te();const o=s&&Yd(s(n)),a=bn(je,{key:n.key||o&&o.key||`_${e}`},o||(i?i():[]),o&&t._===1?64:-2);return!r&&a.scopeId&&(a.slotScopeIds=[a.scopeId+"-s"]),s&&s._c&&(s._d=!0),a}function Yd(t){return t.some(e=>vs(e)?!(e.type===mt||e.type===je&&!Yd(e.children)):!0)?t:null}const la=t=>t?ah(t)?bl(t)||t.proxy:la(t.parent):null,gs=We(Object.create(null),{$:t=>t,$el:t=>t.vnode.el,$data:t=>t.data,$props:t=>t.props,$attrs:t=>t.attrs,$slots:t=>t.slots,$refs:t=>t.refs,$parent:t=>la(t.parent),$root:t=>la(t.root),$emit:t=>t.emit,$options:t=>gl(t),$forceUpdate:t=>t.f||(t.f=()=>fl(t.update)),$nextTick:t=>t.n||(t.n=Pd.bind(t.proxy)),$watch:t=>y_.bind(t)}),O_={get({_:t},e){const{ctx:n,setupState:i,data:r,props:s,accessCache:o,type:a,appContext:l}=t;let c;if(e[0]!=="$"){const p=o[e];if(p!==void 0)switch(p){case 1:return i[e];case 2:return r[e];case 4:return n[e];case 3:return s[e]}else{if(i!==ve&&ie(i,e))return o[e]=1,i[e];if(r!==ve&&ie(r,e))return o[e]=2,r[e];if((c=t.propsOptions[0])&&ie(c,e))return o[e]=3,s[e];if(n!==ve&&ie(n,e))return o[e]=4,n[e];ca&&(o[e]=0)}}const u=gs[e];let f,d;if(u)return e==="$attrs"&&ut(t,"get",e),u(t);if((f=a.__cssModules)&&(f=f[e]))return f;if(n!==ve&&ie(n,e))return o[e]=4,n[e];if(d=l.config.globalProperties,ie(d,e))return d[e]},set({_:t},e,n){const{data:i,setupState:r,ctx:s}=t;return r!==ve&&ie(r,e)?(r[e]=n,!0):i!==ve&&ie(i,e)?(i[e]=n,!0):ie(t.props,e)||e[0]==="$"&&e.slice(1)in t?!1:(s[e]=n,!0)},has({_:{data:t,setupState:e,accessCache:n,ctx:i,appContext:r,propsOptions:s}},o){let a;return!!n[o]||t!==ve&&ie(t,o)||e!==ve&&ie(e,o)||(a=s[0])&&ie(a,o)||ie(i,o)||ie(gs,o)||ie(r.config.globalProperties,o)},defineProperty(t,e,n){return n.get!=null?t._.accessCache[e]=0:ie(n,"value")&&this.set(t,e,n.value,null),Reflect.defineProperty(t,e,n)}};let ca=!0;function P_(t){const e=gl(t),n=t.proxy,i=t.ctx;ca=!1,e.beforeCreate&&Wc(e.beforeCreate,t,"bc");const{data:r,computed:s,methods:o,watch:a,provide:l,inject:c,created:u,beforeMount:f,mounted:d,beforeUpdate:p,updated:g,activated:b,deactivated:I,beforeDestroy:_,beforeUnmount:w,destroyed:O,unmounted:B,render:V,renderTracked:le,renderTriggered:ue,errorCaptured:q,serverPrefetch:ne,expose:ae,inheritAttrs:Me,components:L,directives:be,filters:Ve}=e;if(c&&M_(c,i,null,t.appContext.config.unwrapInjectedRef),o)for(const me in o){const fe=o[me];K(fe)&&(i[me]=fe.bind(n))}if(r){const me=r.call(n,n);Ie(me)&&(t.data=Mi(me))}if(ca=!0,s)for(const me in s){const fe=s[me],_t=K(fe)?fe.bind(n,n):K(fe.get)?fe.get.bind(n,n):St,Nn=!K(fe)&&K(fe.set)?fe.set.bind(n):St,vt=Ce({get:_t,set:Nn});Object.defineProperty(i,me,{enumerable:!0,configurable:!0,get:()=>vt.value,set:tt=>vt.value=tt})}if(a)for(const me in a)Kd(a[me],i,n,me);if(l){const me=K(l)?l.call(n):l;Reflect.ownKeys(me).forEach(fe=>{cs(fe,me[fe])})}u&&Wc(u,t,"c");function Te(me,fe){W(fe)?fe.forEach(_t=>me(_t.bind(n))):fe&&me(fe.bind(n))}if(Te(I_,f),Te(hl,d),Te(T_,p),Te(zd,g),Te(E_,b),Te(C_,I),Te(N_,q),Te(k_,le),Te(A_,ue),Te(Wd,w),Te(Vd,B),Te(S_,ne),W(ae))if(ae.length){const me=t.exposed||(t.exposed={});ae.forEach(fe=>{Object.defineProperty(me,fe,{get:()=>n[fe],set:_t=>n[fe]=_t})})}else t.exposed||(t.exposed={});V&&t.render===St&&(t.render=V),Me!=null&&(t.inheritAttrs=Me),L&&(t.components=L),be&&(t.directives=be)}function M_(t,e,n=St,i=!1){W(t)&&(t=ua(t));for(const r in t){const s=t[r];let o;Ie(s)?"default"in s?o=Vt(s.from||r,s.default,!0):o=Vt(s.from||r):o=Vt(s),Re(o)&&i?Object.defineProperty(e,r,{enumerable:!0,configurable:!0,get:()=>o.value,set:a=>o.value=a}):e[r]=o}}function Wc(t,e,n){pt(W(t)?t.map(i=>i.bind(e.proxy)):t.bind(e.proxy),e,n)}function Kd(t,e,n,i){const r=i.includes(".")?Bd(n,i):()=>n[i];if(Fe(t)){const s=e[t];K(s)&&qn(r,s)}else if(K(t))qn(r,t.bind(n));else if(Ie(t))if(W(t))t.forEach(s=>Kd(s,e,n,i));else{const s=K(t.handler)?t.handler.bind(n):e[t.handler];K(s)&&qn(r,s,t)}}function gl(t){const e=t.type,{mixins:n,extends:i}=e,{mixins:r,optionsCache:s,config:{optionMergeStrategies:o}}=t.appContext,a=s.get(e);let l;return a?l=a:!r.length&&!n&&!i?l=e:(l={},r.length&&r.forEach(c=>_s(l,c,o,!0)),_s(l,e,o)),Ie(e)&&s.set(e,l),l}function _s(t,e,n,i=!1){const{mixins:r,extends:s}=e;s&&_s(t,s,n,!0),r&&r.forEach(o=>_s(t,o,n,!0));for(const o in e)if(!(i&&o==="expose")){const a=D_[o]||n&&n[o];t[o]=a?a(t[o],e[o]):e[o]}return t}const D_={data:Vc,props:Mn,emits:Mn,methods:Mn,computed:Mn,beforeCreate:Xe,created:Xe,beforeMount:Xe,mounted:Xe,beforeUpdate:Xe,updated:Xe,beforeDestroy:Xe,beforeUnmount:Xe,destroyed:Xe,unmounted:Xe,activated:Xe,deactivated:Xe,errorCaptured:Xe,serverPrefetch:Xe,components:Mn,directives:Mn,watch:F_,provide:Vc,inject:L_};function Vc(t,e){return e?t?function(){return We(K(t)?t.call(this,this):t,K(e)?e.call(this,this):e)}:e:t}function L_(t,e){return Mn(ua(t),ua(e))}function ua(t){if(W(t)){const e={};for(let n=0;n<t.length;n++)e[t[n]]=t[n];return e}return t}function Xe(t,e){return t?[...new Set([].concat(t,e))]:e}function Mn(t,e){return t?We(We(Object.create(null),t),e):e}function F_(t,e){if(!t)return e;if(!e)return t;const n=We(Object.create(null),t);for(const i in e)n[i]=Xe(t[i],e[i]);return n}function $_(t,e,n,i=!1){const r={},s={};hs(s,io,1),t.propsDefaults=Object.create(null),Qd(t,e,r,s);for(const o in t.propsOptions[0])o in r||(r[o]=void 0);n?t.props=i?r:t_(r):t.type.props?t.props=r:t.props=s,t.attrs=s}function B_(t,e,n,i){const{props:r,attrs:s,vnode:{patchFlag:o}}=t,a=oe(r),[l]=t.propsOptions;let c=!1;if((i||o>0)&&!(o&16)){if(o&8){const u=t.vnode.dynamicProps;for(let f=0;f<u.length;f++){let d=u[f];if(Xs(t.emitsOptions,d))continue;const p=e[d];if(l)if(ie(s,d))p!==s[d]&&(s[d]=p,c=!0);else{const g=Bt(d);r[g]=fa(l,a,g,p,t,!1)}else p!==s[d]&&(s[d]=p,c=!0)}}}else{Qd(t,e,r,s)&&(c=!0);let u;for(const f in a)(!e||!ie(e,f)&&((u=Ri(f))===f||!ie(e,u)))&&(l?n&&(n[f]!==void 0||n[u]!==void 0)&&(r[f]=fa(l,a,f,void 0,t,!0)):delete r[f]);if(s!==a)for(const f in s)(!e||!ie(e,f)&&!0)&&(delete s[f],c=!0)}c&&Gt(t,"set","$attrs")}function Qd(t,e,n,i){const[r,s]=t.propsOptions;let o=!1,a;if(e)for(let l in e){if(ls(l))continue;const c=e[l];let u;r&&ie(r,u=Bt(l))?!s||!s.includes(u)?n[u]=c:(a||(a={}))[u]=c:Xs(t.emitsOptions,l)||(!(l in i)||c!==i[l])&&(i[l]=c,o=!0)}if(s){const l=oe(n),c=a||ve;for(let u=0;u<s.length;u++){const f=s[u];n[f]=fa(r,l,f,c[f],t,!ie(c,f))}}return o}function fa(t,e,n,i,r,s){const o=t[n];if(o!=null){const a=ie(o,"default");if(a&&i===void 0){const l=o.default;if(o.type!==Function&&K(l)){const{propsDefaults:c}=r;n in c?i=c[n]:(Ci(r),i=c[n]=l.call(null,e),Gn())}else i=l}o[0]&&(s&&!a?i=!1:o[1]&&(i===""||i===Ri(n))&&(i=!0))}return i}function Xd(t,e,n=!1){const i=e.propsCache,r=i.get(t);if(r)return r;const s=t.props,o={},a=[];let l=!1;if(!K(t)){const u=f=>{l=!0;const[d,p]=Xd(f,e,!0);We(o,d),p&&a.push(...p)};!n&&e.mixins.length&&e.mixins.forEach(u),t.extends&&u(t.extends),t.mixins&&t.mixins.forEach(u)}if(!s&&!l)return Ie(t)&&i.set(t,pi),pi;if(W(s))for(let u=0;u<s.length;u++){const f=Bt(s[u]);qc(f)&&(o[f]=ve)}else if(s)for(const u in s){const f=Bt(u);if(qc(f)){const d=s[u],p=o[f]=W(d)||K(d)?{type:d}:d;if(p){const g=Kc(Boolean,p.type),b=Kc(String,p.type);p[0]=g>-1,p[1]=b<0||g<b,(g>-1||ie(p,"default"))&&a.push(f)}}}const c=[o,a];return Ie(t)&&i.set(t,c),c}function qc(t){return t[0]!=="$"}function Gc(t){const e=t&&t.toString().match(/^\s*function (\w+)/);return e?e[1]:t===null?"null":""}function Yc(t,e){return Gc(t)===Gc(e)}function Kc(t,e){return W(e)?e.findIndex(n=>Yc(n,t)):K(e)&&Yc(e,t)?0:-1}const Jd=t=>t[0]==="_"||t==="$stable",_l=t=>W(t)?t.map(Pt):[Pt(t)],H_=(t,e,n)=>{if(e._n)return e;const i=Ye((...r)=>_l(e(...r)),n);return i._c=!1,i},Zd=(t,e,n)=>{const i=t._ctx;for(const r in t){if(Jd(r))continue;const s=t[r];if(K(s))e[r]=H_(r,s,i);else if(s!=null){const o=_l(s);e[r]=()=>o}}},eh=(t,e)=>{const n=_l(e);t.slots.default=()=>n},j_=(t,e)=>{if(t.vnode.shapeFlag&32){const n=e._;n?(t.slots=oe(e),hs(e,"_",n)):Zd(e,t.slots={})}else t.slots={},e&&eh(t,e);hs(t.slots,io,1)},U_=(t,e,n)=>{const{vnode:i,slots:r}=t;let s=!0,o=ve;if(i.shapeFlag&32){const a=e._;a?n&&a===1?s=!1:(We(r,e),!n&&a===1&&delete r._):(s=!e.$stable,Zd(e,r)),o=e}else e&&(eh(t,e),o={default:1});if(s)for(const a in r)!Jd(a)&&!(a in o)&&delete r[a]};function th(){return{app:null,config:{isNativeTag:yg,performance:!1,globalProperties:{},optionMergeStrategies:{},errorHandler:void 0,warnHandler:void 0,compilerOptions:{}},mixins:[],components:{},directives:{},provides:Object.create(null),optionsCache:new WeakMap,propsCache:new WeakMap,emitsCache:new WeakMap}}let z_=0;function W_(t,e){return function(i,r=null){K(i)||(i=Object.assign({},i)),r!=null&&!Ie(r)&&(r=null);const s=th(),o=new Set;let a=!1;const l=s.app={_uid:z_++,_component:i,_props:r,_container:null,_context:s,_instance:null,version:lv,get config(){return s.config},set config(c){},use(c,...u){return o.has(c)||(c&&K(c.install)?(o.add(c),c.install(l,...u)):K(c)&&(o.add(c),c(l,...u))),l},mixin(c){return s.mixins.includes(c)||s.mixins.push(c),l},component(c,u){return u?(s.components[c]=u,l):s.components[c]},directive(c,u){return u?(s.directives[c]=u,l):s.directives[c]},mount(c,u,f){if(!a){const d=Y(i,r);return d.appContext=s,u&&e?e(d,c):t(d,c,f),a=!0,l._container=c,c.__vue_app__=l,bl(d.component)||d.component.proxy}},unmount(){a&&(t(null,l._container),delete l._container.__vue_app__)},provide(c,u){return s.provides[c]=u,l}};return l}}function da(t,e,n,i,r=!1){if(W(t)){t.forEach((d,p)=>da(d,e&&(W(e)?e[p]:e),n,i,r));return}if(Ki(i)&&!r)return;const s=i.shapeFlag&4?bl(i.component)||i.component.proxy:i.el,o=r?null:s,{i:a,r:l}=t,c=e&&e.r,u=a.refs===ve?a.refs={}:a.refs,f=a.setupState;if(c!=null&&c!==l&&(Fe(c)?(u[c]=null,ie(f,c)&&(f[c]=null)):Re(c)&&(c.value=null)),K(l))pn(l,a,12,[o,u]);else{const d=Fe(l),p=Re(l);if(d||p){const g=()=>{if(t.f){const b=d?u[l]:l.value;r?W(b)&&el(b,s):W(b)?b.includes(s)||b.push(s):d?(u[l]=[s],ie(f,l)&&(f[l]=u[l])):(l.value=[s],t.k&&(u[t.k]=l.value))}else d?(u[l]=o,ie(f,l)&&(f[l]=o)):p&&(l.value=o,t.k&&(u[t.k]=o))};o?(g.id=-1,it(g,n)):g()}}}const it=v_;function V_(t){return q_(t)}function q_(t,e){const n=Ig();n.__VUE__=!0;const{insert:i,remove:r,patchProp:s,createElement:o,createText:a,createComment:l,setText:c,setElementText:u,parentNode:f,nextSibling:d,setScopeId:p=St,insertStaticContent:g}=t,b=(h,m,v,y=null,C=null,A=null,R=!1,T=null,k=!!m.dynamicChildren)=>{if(h===m)return;h&&!$n(h,m)&&(y=N(h),tt(h,C,A,!0),h=null),m.patchFlag===-2&&(k=!1,m.dynamicChildren=null);const{type:x,ref:j,shapeFlag:F}=m;switch(x){case vl:I(h,m,v,y);break;case mt:_(h,m,v,y);break;case No:h==null&&w(m,v,y,R);break;case je:L(h,m,v,y,C,A,R,T,k);break;default:F&1?V(h,m,v,y,C,A,R,T,k):F&6?be(h,m,v,y,C,A,R,T,k):(F&64||F&128)&&x.process(h,m,v,y,C,A,R,T,k,re)}j!=null&&C&&da(j,h&&h.ref,A,m||h,!m)},I=(h,m,v,y)=>{if(h==null)i(m.el=a(m.children),v,y);else{const C=m.el=h.el;m.children!==h.children&&c(C,m.children)}},_=(h,m,v,y)=>{h==null?i(m.el=l(m.children||""),v,y):m.el=h.el},w=(h,m,v,y)=>{[h.el,h.anchor]=g(h.children,m,v,y,h.el,h.anchor)},O=({el:h,anchor:m},v,y)=>{let C;for(;h&&h!==m;)C=d(h),i(h,v,y),h=C;i(m,v,y)},B=({el:h,anchor:m})=>{let v;for(;h&&h!==m;)v=d(h),r(h),h=v;r(m)},V=(h,m,v,y,C,A,R,T,k)=>{R=R||m.type==="svg",h==null?le(m,v,y,C,A,R,T,k):ne(h,m,C,A,R,T,k)},le=(h,m,v,y,C,A,R,T)=>{let k,x;const{type:j,props:F,shapeFlag:U,transition:G,dirs:Z}=h;if(k=h.el=o(h.type,A,F&&F.is,F),U&8?u(k,h.children):U&16&&q(h.children,k,null,y,C,A&&j!=="foreignObject",R,T),Z&&Rn(h,null,y,"created"),F){for(const de in F)de!=="value"&&!ls(de)&&s(k,de,null,F[de],A,h.children,y,C,P);"value"in F&&s(k,"value",null,F.value),(x=F.onVnodeBeforeMount)&&Ot(x,y,h)}ue(k,h,h.scopeId,R,y),Z&&Rn(h,null,y,"beforeMount");const ge=(!C||C&&!C.pendingBranch)&&G&&!G.persisted;ge&&G.beforeEnter(k),i(k,m,v),((x=F&&F.onVnodeMounted)||ge||Z)&&it(()=>{x&&Ot(x,y,h),ge&&G.enter(k),Z&&Rn(h,null,y,"mounted")},C)},ue=(h,m,v,y,C)=>{if(v&&p(h,v),y)for(let A=0;A<y.length;A++)p(h,y[A]);if(C){let A=C.subTree;if(m===A){const R=C.vnode;ue(h,R,R.scopeId,R.slotScopeIds,C.parent)}}},q=(h,m,v,y,C,A,R,T,k=0)=>{for(let x=k;x<h.length;x++){const j=h[x]=T?fn(h[x]):Pt(h[x]);b(null,j,m,v,y,C,A,R,T)}},ne=(h,m,v,y,C,A,R)=>{const T=m.el=h.el;let{patchFlag:k,dynamicChildren:x,dirs:j}=m;k|=h.patchFlag&16;const F=h.props||ve,U=m.props||ve;let G;v&&On(v,!1),(G=U.onVnodeBeforeUpdate)&&Ot(G,v,m,h),j&&Rn(m,h,v,"beforeUpdate"),v&&On(v,!0);const Z=C&&m.type!=="foreignObject";if(x?ae(h.dynamicChildren,x,T,v,y,Z,A):R||fe(h,m,T,null,v,y,Z,A,!1),k>0){if(k&16)Me(T,m,F,U,v,y,C);else if(k&2&&F.class!==U.class&&s(T,"class",null,U.class,C),k&4&&s(T,"style",F.style,U.style,C),k&8){const ge=m.dynamicProps;for(let de=0;de<ge.length;de++){const Ne=ge[de],yt=F[Ne],oi=U[Ne];(oi!==yt||Ne==="value")&&s(T,Ne,yt,oi,C,h.children,v,y,P)}}k&1&&h.children!==m.children&&u(T,m.children)}else!R&&x==null&&Me(T,m,F,U,v,y,C);((G=U.onVnodeUpdated)||j)&&it(()=>{G&&Ot(G,v,m,h),j&&Rn(m,h,v,"updated")},y)},ae=(h,m,v,y,C,A,R)=>{for(let T=0;T<m.length;T++){const k=h[T],x=m[T],j=k.el&&(k.type===je||!$n(k,x)||k.shapeFlag&70)?f(k.el):v;b(k,x,j,null,y,C,A,R,!0)}},Me=(h,m,v,y,C,A,R)=>{if(v!==y){if(v!==ve)for(const T in v)!ls(T)&&!(T in y)&&s(h,T,v[T],null,R,m.children,C,A,P);for(const T in y){if(ls(T))continue;const k=y[T],x=v[T];k!==x&&T!=="value"&&s(h,T,x,k,R,m.children,C,A,P)}"value"in y&&s(h,"value",v.value,y.value)}},L=(h,m,v,y,C,A,R,T,k)=>{const x=m.el=h?h.el:a(""),j=m.anchor=h?h.anchor:a("");let{patchFlag:F,dynamicChildren:U,slotScopeIds:G}=m;G&&(T=T?T.concat(G):G),h==null?(i(x,v,y),i(j,v,y),q(m.children,v,j,C,A,R,T,k)):F>0&&F&64&&U&&h.dynamicChildren?(ae(h.dynamicChildren,U,v,C,A,R,T),(m.key!=null||C&&m===C.subTree)&&nh(h,m,!0)):fe(h,m,v,j,C,A,R,T,k)},be=(h,m,v,y,C,A,R,T,k)=>{m.slotScopeIds=T,h==null?m.shapeFlag&512?C.ctx.activate(m,v,y,R,k):Ve(m,v,y,C,A,R,k):sn(h,m,k)},Ve=(h,m,v,y,C,A,R)=>{const T=h.component=tv(h,y,C);if(to(h)&&(T.ctx.renderer=re),nv(T),T.asyncDep){if(C&&C.registerDep(T,Te),!h.el){const k=T.subTree=Y(mt);_(null,k,m,v)}return}Te(T,h,m,v,C,A,R)},sn=(h,m,v)=>{const y=m.component=h.component;if(m_(h,m,v))if(y.asyncDep&&!y.asyncResolved){me(y,m,v);return}else y.next=m,c_(y.update),y.update();else m.el=h.el,y.vnode=m},Te=(h,m,v,y,C,A,R)=>{const T=()=>{if(h.isMounted){let{next:j,bu:F,u:U,parent:G,vnode:Z}=h,ge=j,de;On(h,!1),j?(j.el=Z.el,me(h,j,R)):j=Z,F&&So(F),(de=j.props&&j.props.onVnodeBeforeUpdate)&&Ot(de,G,j,Z),On(h,!0);const Ne=Ao(h),yt=h.subTree;h.subTree=Ne,b(yt,Ne,f(yt.el),N(yt),h,C,A),j.el=Ne.el,ge===null&&g_(h,Ne.el),U&&it(U,C),(de=j.props&&j.props.onVnodeUpdated)&&it(()=>Ot(de,G,j,Z),C)}else{let j;const{el:F,props:U}=m,{bm:G,m:Z,parent:ge}=h,de=Ki(m);if(On(h,!1),G&&So(G),!de&&(j=U&&U.onVnodeBeforeMount)&&Ot(j,ge,m),On(h,!0),F&&Q){const Ne=()=>{h.subTree=Ao(h),Q(F,h.subTree,h,C,null)};de?m.type.__asyncLoader().then(()=>!h.isUnmounted&&Ne()):Ne()}else{const Ne=h.subTree=Ao(h);b(null,Ne,v,y,h,C,A),m.el=Ne.el}if(Z&&it(Z,C),!de&&(j=U&&U.onVnodeMounted)){const Ne=m;it(()=>Ot(j,ge,Ne),C)}(m.shapeFlag&256||ge&&Ki(ge.vnode)&&ge.vnode.shapeFlag&256)&&h.a&&it(h.a,C),h.isMounted=!0,m=v=y=null}},k=h.effect=new rl(T,()=>fl(x),h.scope),x=h.update=()=>k.run();x.id=h.uid,On(h,!0),x()},me=(h,m,v)=>{m.component=h;const y=h.vnode.props;h.vnode=m,h.next=null,B_(h,m.props,y,v),U_(h,m.children,v),Oi(),Bc(),Pi()},fe=(h,m,v,y,C,A,R,T,k=!1)=>{const x=h&&h.children,j=h?h.shapeFlag:0,F=m.children,{patchFlag:U,shapeFlag:G}=m;if(U>0){if(U&128){Nn(x,F,v,y,C,A,R,T,k);return}else if(U&256){_t(x,F,v,y,C,A,R,T,k);return}}G&8?(j&16&&P(x,C,A),F!==x&&u(v,F)):j&16?G&16?Nn(x,F,v,y,C,A,R,T,k):P(x,C,A,!0):(j&8&&u(v,""),G&16&&q(F,v,y,C,A,R,T,k))},_t=(h,m,v,y,C,A,R,T,k)=>{h=h||pi,m=m||pi;const x=h.length,j=m.length,F=Math.min(x,j);let U;for(U=0;U<F;U++){const G=m[U]=k?fn(m[U]):Pt(m[U]);b(h[U],G,v,null,C,A,R,T,k)}x>j?P(h,C,A,!0,!1,F):q(m,v,y,C,A,R,T,k,F)},Nn=(h,m,v,y,C,A,R,T,k)=>{let x=0;const j=m.length;let F=h.length-1,U=j-1;for(;x<=F&&x<=U;){const G=h[x],Z=m[x]=k?fn(m[x]):Pt(m[x]);if($n(G,Z))b(G,Z,v,null,C,A,R,T,k);else break;x++}for(;x<=F&&x<=U;){const G=h[F],Z=m[U]=k?fn(m[U]):Pt(m[U]);if($n(G,Z))b(G,Z,v,null,C,A,R,T,k);else break;F--,U--}if(x>F){if(x<=U){const G=U+1,Z=G<j?m[G].el:y;for(;x<=U;)b(null,m[x]=k?fn(m[x]):Pt(m[x]),v,Z,C,A,R,T,k),x++}}else if(x>U)for(;x<=F;)tt(h[x],C,A,!0),x++;else{const G=x,Z=x,ge=new Map;for(x=Z;x<=U;x++){const at=m[x]=k?fn(m[x]):Pt(m[x]);at.key!=null&&ge.set(at.key,x)}let de,Ne=0;const yt=U-Z+1;let oi=!1,Ac=0;const Hi=new Array(yt);for(x=0;x<yt;x++)Hi[x]=0;for(x=G;x<=F;x++){const at=h[x];if(Ne>=yt){tt(at,C,A,!0);continue}let Rt;if(at.key!=null)Rt=ge.get(at.key);else for(de=Z;de<=U;de++)if(Hi[de-Z]===0&&$n(at,m[de])){Rt=de;break}Rt===void 0?tt(at,C,A,!0):(Hi[Rt-Z]=x+1,Rt>=Ac?Ac=Rt:oi=!0,b(at,m[Rt],v,null,C,A,R,T,k),Ne++)}const kc=oi?G_(Hi):pi;for(de=kc.length-1,x=yt-1;x>=0;x--){const at=Z+x,Rt=m[at],Nc=at+1<j?m[at+1].el:y;Hi[x]===0?b(null,Rt,v,Nc,C,A,R,T,k):oi&&(de<0||x!==kc[de]?vt(Rt,v,Nc,2):de--)}}},vt=(h,m,v,y,C=null)=>{const{el:A,type:R,transition:T,children:k,shapeFlag:x}=h;if(x&6){vt(h.component.subTree,m,v,y);return}if(x&128){h.suspense.move(m,v,y);return}if(x&64){R.move(h,m,v,re);return}if(R===je){i(A,m,v);for(let F=0;F<k.length;F++)vt(k[F],m,v,y);i(h.anchor,m,v);return}if(R===No){O(h,m,v);return}if(y!==2&&x&1&&T)if(y===0)T.beforeEnter(A),i(A,m,v),it(()=>T.enter(A),C);else{const{leave:F,delayLeave:U,afterLeave:G}=T,Z=()=>i(A,m,v),ge=()=>{F(A,()=>{Z(),G&&G()})};U?U(A,Z,ge):ge()}else i(A,m,v)},tt=(h,m,v,y=!1,C=!1)=>{const{type:A,props:R,ref:T,children:k,dynamicChildren:x,shapeFlag:j,patchFlag:F,dirs:U}=h;if(T!=null&&da(T,null,v,h,!0),j&256){m.ctx.deactivate(h);return}const G=j&1&&U,Z=!Ki(h);let ge;if(Z&&(ge=R&&R.onVnodeBeforeUnmount)&&Ot(ge,m,h),j&6)E(h.component,v,y);else{if(j&128){h.suspense.unmount(v,y);return}G&&Rn(h,null,m,"beforeUnmount"),j&64?h.type.remove(h,m,v,C,re,y):x&&(A!==je||F>0&&F&64)?P(x,m,v,!1,!0):(A===je&&F&384||!C&&j&16)&&P(k,m,v),y&&si(h)}(Z&&(ge=R&&R.onVnodeUnmounted)||G)&&it(()=>{ge&&Ot(ge,m,h),G&&Rn(h,null,m,"unmounted")},v)},si=h=>{const{type:m,el:v,anchor:y,transition:C}=h;if(m===je){zr(v,y);return}if(m===No){B(h);return}const A=()=>{r(v),C&&!C.persisted&&C.afterLeave&&C.afterLeave()};if(h.shapeFlag&1&&C&&!C.persisted){const{leave:R,delayLeave:T}=C,k=()=>R(v,A);T?T(h.el,A,k):k()}else A()},zr=(h,m)=>{let v;for(;h!==m;)v=d(h),r(h),h=v;r(m)},E=(h,m,v)=>{const{bum:y,scope:C,update:A,subTree:R,um:T}=h;y&&So(y),C.stop(),A&&(A.active=!1,tt(R,h,m,v)),T&&it(T,m),it(()=>{h.isUnmounted=!0},m),m&&m.pendingBranch&&!m.isUnmounted&&h.asyncDep&&!h.asyncResolved&&h.suspenseId===m.pendingId&&(m.deps--,m.deps===0&&m.resolve())},P=(h,m,v,y=!1,C=!1,A=0)=>{for(let R=A;R<h.length;R++)tt(h[R],m,v,y,C)},N=h=>h.shapeFlag&6?N(h.component.subTree):h.shapeFlag&128?h.suspense.next():d(h.anchor||h.el),H=(h,m,v)=>{h==null?m._vnode&&tt(m._vnode,null,null,!0):b(m._vnode||null,h,m,null,null,null,v),Bc(),Dd(),m._vnode=h},re={p:b,um:tt,m:vt,r:si,mt:Ve,mc:q,pc:fe,pbc:ae,n:N,o:t};let Se,Q;return e&&([Se,Q]=e(re)),{render:H,hydrate:Se,createApp:W_(H,Se)}}function On({effect:t,update:e},n){t.allowRecurse=e.allowRecurse=n}function nh(t,e,n=!1){const i=t.children,r=e.children;if(W(i)&&W(r))for(let s=0;s<i.length;s++){const o=i[s];let a=r[s];a.shapeFlag&1&&!a.dynamicChildren&&((a.patchFlag<=0||a.patchFlag===32)&&(a=r[s]=fn(r[s]),a.el=o.el),n||nh(o,a))}}function G_(t){const e=t.slice(),n=[0];let i,r,s,o,a;const l=t.length;for(i=0;i<l;i++){const c=t[i];if(c!==0){if(r=n[n.length-1],t[r]<c){e[i]=r,n.push(i);continue}for(s=0,o=n.length-1;s<o;)a=s+o>>1,t[n[a]]<c?s=a+1:o=a;c<t[n[s]]&&(s>0&&(e[i]=n[s-1]),n[s]=i)}}for(s=n.length,o=n[s-1];s-- >0;)n[s]=o,o=e[o];return n}const Y_=t=>t.__isTeleport,je=Symbol(void 0),vl=Symbol(void 0),mt=Symbol(void 0),No=Symbol(void 0),Qi=[];let Ct=null;function te(t=!1){Qi.push(Ct=t?null:[])}function K_(){Qi.pop(),Ct=Qi[Qi.length-1]||null}let pr=1;function Qc(t){pr+=t}function ih(t){return t.dynamicChildren=pr>0?Ct||pi:null,K_(),pr>0&&Ct&&Ct.push(t),t}function he(t,e,n,i,r,s){return ih(D(t,e,n,i,r,s,!0))}function bn(t,e,n,i,r){return ih(Y(t,e,n,i,r,!0))}function vs(t){return t?t.__v_isVNode===!0:!1}function $n(t,e){return t.type===e.type&&t.key===e.key}const io="__vInternal",rh=({key:t})=>t!=null?t:null,us=({ref:t,ref_key:e,ref_for:n})=>t!=null?Fe(t)||Re(t)||K(t)?{i:Ze,r:t,k:e,f:!!n}:t:null;function D(t,e=null,n=null,i=0,r=null,s=t===je?0:1,o=!1,a=!1){const l={__v_isVNode:!0,__v_skip:!0,type:t,props:e,key:e&&rh(e),ref:e&&us(e),scopeId:Js,slotScopeIds:null,children:n,component:null,suspense:null,ssContent:null,ssFallback:null,dirs:null,transition:null,el:null,anchor:null,target:null,targetAnchor:null,staticCount:0,shapeFlag:s,patchFlag:i,dynamicProps:r,dynamicChildren:null,appContext:null};return a?(yl(l,n),s&128&&t.normalize(l)):n&&(l.shapeFlag|=Fe(n)?8:16),pr>0&&!o&&Ct&&(l.patchFlag>0||s&6)&&l.patchFlag!==32&&Ct.push(l),l}const Y=Q_;function Q_(t,e=null,n=null,i=0,r=null,s=!1){if((!t||t===qd)&&(t=mt),vs(t)){const a=wn(t,e,!0);return n&&yl(a,n),pr>0&&!s&&Ct&&(a.shapeFlag&6?Ct[Ct.indexOf(t)]=a:Ct.push(a)),a.patchFlag|=-2,a}if(av(t)&&(t=t.__vccOpts),e){e=X_(e);let{class:a,style:l}=e;a&&!Fe(a)&&(e.class=qe(a)),Ie(l)&&(Id(l)&&!W(l)&&(l=We({},l)),e.style=ar(l))}const o=Fe(t)?1:__(t)?128:Y_(t)?64:Ie(t)?4:K(t)?2:0;return D(t,e,n,i,r,o,s,!0)}function X_(t){return t?Id(t)||io in t?We({},t):t:null}function wn(t,e,n=!1){const{props:i,ref:r,patchFlag:s,children:o}=t,a=e?J_(i||{},e):i;return{__v_isVNode:!0,__v_skip:!0,type:t.type,props:a,key:a&&rh(a),ref:e&&e.ref?n&&r?W(r)?r.concat(us(e)):[r,us(e)]:us(e):r,scopeId:t.scopeId,slotScopeIds:t.slotScopeIds,children:o,target:t.target,targetAnchor:t.targetAnchor,staticCount:t.staticCount,shapeFlag:t.shapeFlag,patchFlag:e&&t.type!==je?s===-1?16:s|16:s,dynamicProps:t.dynamicProps,dynamicChildren:t.dynamicChildren,appContext:t.appContext,dirs:t.dirs,transition:t.transition,component:t.component,suspense:t.suspense,ssContent:t.ssContent&&wn(t.ssContent),ssFallback:t.ssFallback&&wn(t.ssFallback),el:t.el,anchor:t.anchor}}function sh(t=" ",e=0){return Y(vl,null,t,e)}function Lt(t="",e=!1){return e?(te(),bn(mt,null,t)):Y(mt,null,t)}function Pt(t){return t==null||typeof t=="boolean"?Y(mt):W(t)?Y(je,null,t.slice()):typeof t=="object"?fn(t):Y(vl,null,String(t))}function fn(t){return t.el===null&&t.patchFlag!==-1||t.memo?t:wn(t)}function yl(t,e){let n=0;const{shapeFlag:i}=t;if(e==null)e=null;else if(W(e))n=16;else if(typeof e=="object")if(i&65){const r=e.default;r&&(r._c&&(r._d=!1),yl(t,r()),r._c&&(r._d=!0));return}else{n=32;const r=e._;!r&&!(io in e)?e._ctx=Ze:r===3&&Ze&&(Ze.slots._===1?e._=1:(e._=2,t.patchFlag|=1024))}else K(e)?(e={default:e,_ctx:Ze},n=32):(e=String(e),i&64?(n=16,e=[sh(e)]):n=8);t.children=e,t.shapeFlag|=n}function J_(...t){const e={};for(let n=0;n<t.length;n++){const i=t[n];for(const r in i)if(r==="class")e.class!==i.class&&(e.class=qe([e.class,i.class]));else if(r==="style")e.style=ar([e.style,i.style]);else if(Vs(r)){const s=e[r],o=i[r];o&&s!==o&&!(W(s)&&s.includes(o))&&(e[r]=s?[].concat(s,o):o)}else r!==""&&(e[r]=i[r])}return e}function Ot(t,e,n,i=null){pt(t,e,7,[n,i])}const Z_=th();let ev=0;function tv(t,e,n){const i=t.type,r=(e?e.appContext:t.appContext)||Z_,s={uid:ev++,vnode:t,type:i,parent:e,appContext:r,root:null,next:null,subTree:null,effect:null,update:null,scope:new Tg(!0),render:null,proxy:null,exposed:null,exposeProxy:null,withProxy:null,provides:e?e.provides:Object.create(r.provides),accessCache:null,renderCache:[],components:null,directives:null,propsOptions:Xd(i,r),emitsOptions:Fd(i,r),emit:null,emitted:null,propsDefaults:ve,inheritAttrs:i.inheritAttrs,ctx:ve,data:ve,props:ve,attrs:ve,slots:ve,refs:ve,setupState:ve,setupContext:null,suspense:n,suspenseId:n?n.pendingId:0,asyncDep:null,asyncResolved:!1,isMounted:!1,isUnmounted:!1,isDeactivated:!1,bc:null,c:null,bm:null,m:null,bu:null,u:null,um:null,bum:null,da:null,a:null,rtg:null,rtc:null,ec:null,sp:null};return s.ctx={_:s},s.root=e?e.root:s,s.emit=d_.bind(null,s),t.ce&&t.ce(s),s}let ze=null;const oh=()=>ze||Ze,Ci=t=>{ze=t,t.scope.on()},Gn=()=>{ze&&ze.scope.off(),ze=null};function ah(t){return t.vnode.shapeFlag&4}let mr=!1;function nv(t,e=!1){mr=e;const{props:n,children:i}=t.vnode,r=ah(t);$_(t,n,r,e),j_(t,i);const s=r?iv(t,e):void 0;return mr=!1,s}function iv(t,e){const n=t.type;t.accessCache=Object.create(null),t.proxy=Td(new Proxy(t.ctx,O_));const{setup:i}=n;if(i){const r=t.setupContext=i.length>1?sv(t):null;Ci(t),Oi();const s=pn(i,t,0,[t.props,r]);if(Pi(),Gn(),ud(s)){if(s.then(Gn,Gn),e)return s.then(o=>{Xc(t,o,e)}).catch(o=>{Qs(o,t,0)});t.asyncDep=s}else Xc(t,s,e)}else lh(t,e)}function Xc(t,e,n){K(e)?t.type.__ssrInlineRender?t.ssrRender=e:t.render=e:Ie(e)&&(t.setupState=Nd(e)),lh(t,n)}let Jc;function lh(t,e,n){const i=t.type;if(!t.render){if(!e&&Jc&&!i.render){const r=i.template||gl(t).template;if(r){const{isCustomElement:s,compilerOptions:o}=t.appContext.config,{delimiters:a,compilerOptions:l}=i,c=We(We({isCustomElement:s,delimiters:a},o),l);i.render=Jc(r,c)}}t.render=i.render||St}Ci(t),Oi(),P_(t),Pi(),Gn()}function rv(t){return new Proxy(t.attrs,{get(e,n){return ut(t,"get","$attrs"),e[n]}})}function sv(t){const e=i=>{t.exposed=i||{}};let n;return{get attrs(){return n||(n=rv(t))},slots:t.slots,emit:t.emit,expose:e}}function bl(t){if(t.exposed)return t.exposeProxy||(t.exposeProxy=new Proxy(Nd(Td(t.exposed)),{get(e,n){if(n in e)return e[n];if(n in gs)return gs[n](t)}}))}function ov(t,e=!0){return K(t)?t.displayName||t.name:t.name||e&&t.__name}function av(t){return K(t)&&"__vccOpts"in t}const Ce=(t,e)=>o_(t,e,mr);function ro(t,e,n){const i=arguments.length;return i===2?Ie(e)&&!W(e)?vs(e)?Y(t,null,[e]):Y(t,e):Y(t,null,e):(i>3?n=Array.prototype.slice.call(arguments,2):i===3&&vs(n)&&(n=[n]),Y(t,e,n))}const lv="3.2.40",cv="http://www.w3.org/2000/svg",Bn=typeof document<"u"?document:null,Zc=Bn&&Bn.createElement("template"),uv={insert:(t,e,n)=>{e.insertBefore(t,n||null)},remove:t=>{const e=t.parentNode;e&&e.removeChild(t)},createElement:(t,e,n,i)=>{const r=e?Bn.createElementNS(cv,t):Bn.createElement(t,n?{is:n}:void 0);return t==="select"&&i&&i.multiple!=null&&r.setAttribute("multiple",i.multiple),r},createText:t=>Bn.createTextNode(t),createComment:t=>Bn.createComment(t),setText:(t,e)=>{t.nodeValue=e},setElementText:(t,e)=>{t.textContent=e},parentNode:t=>t.parentNode,nextSibling:t=>t.nextSibling,querySelector:t=>Bn.querySelector(t),setScopeId(t,e){t.setAttribute(e,"")},insertStaticContent(t,e,n,i,r,s){const o=n?n.previousSibling:e.lastChild;if(r&&(r===s||r.nextSibling))for(;e.insertBefore(r.cloneNode(!0),n),!(r===s||!(r=r.nextSibling)););else{Zc.innerHTML=i?`<svg>${t}</svg>`:t;const a=Zc.content;if(i){const l=a.firstChild;for(;l.firstChild;)a.appendChild(l.firstChild);a.removeChild(l)}e.insertBefore(a,n)}return[o?o.nextSibling:e.firstChild,n?n.previousSibling:e.lastChild]}};function fv(t,e,n){const i=t._vtc;i&&(e=(e?[e,...i]:[...i]).join(" ")),e==null?t.removeAttribute("class"):n?t.setAttribute("class",e):t.className=e}function dv(t,e,n){const i=t.style,r=Fe(n);if(n&&!r){for(const s in n)ha(i,s,n[s]);if(e&&!Fe(e))for(const s in e)n[s]==null&&ha(i,s,"")}else{const s=i.display;r?e!==n&&(i.cssText=n):e&&t.removeAttribute("style"),"_vod"in t&&(i.display=s)}}const eu=/\s*!important$/;function ha(t,e,n){if(W(n))n.forEach(i=>ha(t,e,i));else if(n==null&&(n=""),e.startsWith("--"))t.setProperty(e,n);else{const i=hv(t,e);eu.test(n)?t.setProperty(Ri(i),n.replace(eu,""),"important"):t[i]=n}}const tu=["Webkit","Moz","ms"],Ro={};function hv(t,e){const n=Ro[e];if(n)return n;let i=Bt(e);if(i!=="filter"&&i in t)return Ro[e]=i;i=Ys(i);for(let r=0;r<tu.length;r++){const s=tu[r]+i;if(s in t)return Ro[e]=s}return e}const nu="http://www.w3.org/1999/xlink";function pv(t,e,n,i,r){if(i&&e.startsWith("xlink:"))n==null?t.removeAttributeNS(nu,e.slice(6,e.length)):t.setAttributeNS(nu,e,n);else{const s=mg(e);n==null||s&&!ad(n)?t.removeAttribute(e):t.setAttribute(e,s?"":n)}}function mv(t,e,n,i,r,s,o){if(e==="innerHTML"||e==="textContent"){i&&o(i,r,s),t[e]=n==null?"":n;return}if(e==="value"&&t.tagName!=="PROGRESS"&&!t.tagName.includes("-")){t._value=n;const l=n==null?"":n;(t.value!==l||t.tagName==="OPTION")&&(t.value=l),n==null&&t.removeAttribute(e);return}let a=!1;if(n===""||n==null){const l=typeof t[e];l==="boolean"?n=ad(n):n==null&&l==="string"?(n="",a=!0):l==="number"&&(n=0,a=!0)}try{t[e]=n}catch{}a&&t.removeAttribute(e)}const[ch,gv]=(()=>{let t=Date.now,e=!1;if(typeof window<"u"){Date.now()>document.createEvent("Event").timeStamp&&(t=performance.now.bind(performance));const n=navigator.userAgent.match(/firefox\/(\d+)/i);e=!!(n&&Number(n[1])<=53)}return[t,e]})();let pa=0;const _v=Promise.resolve(),vv=()=>{pa=0},yv=()=>pa||(_v.then(vv),pa=ch());function bv(t,e,n,i){t.addEventListener(e,n,i)}function wv(t,e,n,i){t.removeEventListener(e,n,i)}function Ev(t,e,n,i,r=null){const s=t._vei||(t._vei={}),o=s[e];if(i&&o)o.value=i;else{const[a,l]=Cv(e);if(i){const c=s[e]=xv(i,r);bv(t,a,c,l)}else o&&(wv(t,a,o,l),s[e]=void 0)}}const iu=/(?:Once|Passive|Capture)$/;function Cv(t){let e;if(iu.test(t)){e={};let i;for(;i=t.match(iu);)t=t.slice(0,t.length-i[0].length),e[i[0].toLowerCase()]=!0}return[t[2]===":"?t.slice(3):Ri(t.slice(2)),e]}function xv(t,e){const n=i=>{const r=i.timeStamp||ch();(gv||r>=n.attached-1)&&pt(Iv(i,n.value),e,5,[i])};return n.value=t,n.attached=yv(),n}function Iv(t,e){if(W(e)){const n=t.stopImmediatePropagation;return t.stopImmediatePropagation=()=>{n.call(t),t._stopped=!0},e.map(i=>r=>!r._stopped&&i&&i(r))}else return e}const ru=/^on[a-z]/,Tv=(t,e,n,i,r=!1,s,o,a,l)=>{e==="class"?fv(t,i,r):e==="style"?dv(t,n,i):Vs(e)?Za(e)||Ev(t,e,n,i,o):(e[0]==="."?(e=e.slice(1),!0):e[0]==="^"?(e=e.slice(1),!1):Sv(t,e,i,r))?mv(t,e,i,s,o,a,l):(e==="true-value"?t._trueValue=i:e==="false-value"&&(t._falseValue=i),pv(t,e,i,r))};function Sv(t,e,n,i){return i?!!(e==="innerHTML"||e==="textContent"||e in t&&ru.test(e)&&K(n)):e==="spellcheck"||e==="draggable"||e==="translate"||e==="form"||e==="list"&&t.tagName==="INPUT"||e==="type"&&t.tagName==="TEXTAREA"||ru.test(e)&&Fe(n)?!1:e in t}const an="transition",ji="animation",uh={name:String,type:String,css:{type:Boolean,default:!0},duration:[String,Number,Object],enterFromClass:String,enterActiveClass:String,enterToClass:String,appearFromClass:String,appearActiveClass:String,appearToClass:String,leaveFromClass:String,leaveActiveClass:String,leaveToClass:String},Av=We({},w_.props,uh),Pn=(t,e=[])=>{W(t)?t.forEach(n=>n(...e)):t&&t(...e)},su=t=>t?W(t)?t.some(e=>e.length>1):t.length>1:!1;function kv(t){const e={};for(const L in t)L in uh||(e[L]=t[L]);if(t.css===!1)return e;const{name:n="v",type:i,duration:r,enterFromClass:s=`${n}-enter-from`,enterActiveClass:o=`${n}-enter-active`,enterToClass:a=`${n}-enter-to`,appearFromClass:l=s,appearActiveClass:c=o,appearToClass:u=a,leaveFromClass:f=`${n}-leave-from`,leaveActiveClass:d=`${n}-leave-active`,leaveToClass:p=`${n}-leave-to`}=t,g=Nv(r),b=g&&g[0],I=g&&g[1],{onBeforeEnter:_,onEnter:w,onEnterCancelled:O,onLeave:B,onLeaveCancelled:V,onBeforeAppear:le=_,onAppear:ue=w,onAppearCancelled:q=O}=e,ne=(L,be,Ve)=>{un(L,be?u:a),un(L,be?c:o),Ve&&Ve()},ae=(L,be)=>{L._isLeaving=!1,un(L,f),un(L,p),un(L,d),be&&be()},Me=L=>(be,Ve)=>{const sn=L?ue:w,Te=()=>ne(be,L,Ve);Pn(sn,[be,Te]),ou(()=>{un(be,L?l:s),Ut(be,L?u:a),su(sn)||au(be,i,b,Te)})};return We(e,{onBeforeEnter(L){Pn(_,[L]),Ut(L,s),Ut(L,o)},onBeforeAppear(L){Pn(le,[L]),Ut(L,l),Ut(L,c)},onEnter:Me(!1),onAppear:Me(!0),onLeave(L,be){L._isLeaving=!0;const Ve=()=>ae(L,be);Ut(L,f),dh(),Ut(L,d),ou(()=>{!L._isLeaving||(un(L,f),Ut(L,p),su(B)||au(L,i,I,Ve))}),Pn(B,[L,Ve])},onEnterCancelled(L){ne(L,!1),Pn(O,[L])},onAppearCancelled(L){ne(L,!0),Pn(q,[L])},onLeaveCancelled(L){ae(L),Pn(V,[L])}})}function Nv(t){if(t==null)return null;if(Ie(t))return[Oo(t.enter),Oo(t.leave)];{const e=Oo(t);return[e,e]}}function Oo(t){return hd(t)}function Ut(t,e){e.split(/\s+/).forEach(n=>n&&t.classList.add(n)),(t._vtc||(t._vtc=new Set)).add(e)}function un(t,e){e.split(/\s+/).forEach(i=>i&&t.classList.remove(i));const{_vtc:n}=t;n&&(n.delete(e),n.size||(t._vtc=void 0))}function ou(t){requestAnimationFrame(()=>{requestAnimationFrame(t)})}let Rv=0;function au(t,e,n,i){const r=t._endId=++Rv,s=()=>{r===t._endId&&i()};if(n)return setTimeout(s,n);const{type:o,timeout:a,propCount:l}=fh(t,e);if(!o)return i();const c=o+"end";let u=0;const f=()=>{t.removeEventListener(c,d),s()},d=p=>{p.target===t&&++u>=l&&f()};setTimeout(()=>{u<l&&f()},a+1),t.addEventListener(c,d)}function fh(t,e){const n=window.getComputedStyle(t),i=g=>(n[g]||"").split(", "),r=i(an+"Delay"),s=i(an+"Duration"),o=lu(r,s),a=i(ji+"Delay"),l=i(ji+"Duration"),c=lu(a,l);let u=null,f=0,d=0;e===an?o>0&&(u=an,f=o,d=s.length):e===ji?c>0&&(u=ji,f=c,d=l.length):(f=Math.max(o,c),u=f>0?o>c?an:ji:null,d=u?u===an?s.length:l.length:0);const p=u===an&&/\b(transform|all)(,|$)/.test(n[an+"Property"]);return{type:u,timeout:f,propCount:d,hasTransform:p}}function lu(t,e){for(;t.length<e.length;)t=t.concat(t);return Math.max(...e.map((n,i)=>cu(n)+cu(t[i])))}function cu(t){return Number(t.slice(0,-1).replace(",","."))*1e3}function dh(){return document.body.offsetHeight}const hh=new WeakMap,ph=new WeakMap,Ov={name:"TransitionGroup",props:We({},Av,{tag:String,moveClass:String}),setup(t,{slots:e}){const n=oh(),i=Hd();let r,s;return zd(()=>{if(!r.length)return;const o=t.moveClass||`${t.name||"v"}-move`;if(!Lv(r[0].el,n.vnode.el,o))return;r.forEach(Pv),r.forEach(Mv);const a=r.filter(Dv);dh(),a.forEach(l=>{const c=l.el,u=c.style;Ut(c,o),u.transform=u.webkitTransform=u.transitionDuration="";const f=c._moveCb=d=>{d&&d.target!==c||(!d||/transform$/.test(d.propertyName))&&(c.removeEventListener("transitionend",f),c._moveCb=null,un(c,o))};c.addEventListener("transitionend",f)})}),()=>{const o=oe(t),a=kv(o);let l=o.tag||je;r=s,s=e.default?dl(e.default()):[];for(let c=0;c<s.length;c++){const u=s[c];u.key!=null&&hr(u,dr(u,a,i,n))}if(r)for(let c=0;c<r.length;c++){const u=r[c];hr(u,dr(u,a,i,n)),hh.set(u,u.el.getBoundingClientRect())}return Y(l,null,s)}}},mh=Ov;function Pv(t){const e=t.el;e._moveCb&&e._moveCb(),e._enterCb&&e._enterCb()}function Mv(t){ph.set(t,t.el.getBoundingClientRect())}function Dv(t){const e=hh.get(t),n=ph.get(t),i=e.left-n.left,r=e.top-n.top;if(i||r){const s=t.el.style;return s.transform=s.webkitTransform=`translate(${i}px,${r}px)`,s.transitionDuration="0s",t}}function Lv(t,e,n){const i=t.cloneNode();t._vtc&&t._vtc.forEach(o=>{o.split(/\s+/).forEach(a=>a&&i.classList.remove(a))}),n.split(/\s+/).forEach(o=>o&&i.classList.add(o)),i.style.display="none";const r=e.nodeType===1?e:e.parentNode;r.appendChild(i);const{hasTransform:s}=fh(i);return r.removeChild(i),s}const Fv=We({patchProp:Tv},uv);let uu;function $v(){return uu||(uu=V_(Fv))}const Bv=(...t)=>{const e=$v().createApp(...t),{mount:n}=e;return e.mount=i=>{const r=Hv(i);if(!r)return;const s=e._component;!K(s)&&!s.render&&!s.template&&(s.template=r.innerHTML),r.innerHTML="";const o=n(r,!1,r instanceof SVGElement);return r instanceof Element&&(r.removeAttribute("v-cloak"),r.setAttribute("data-v-app","")),o},e};function Hv(t){return Fe(t)?document.querySelector(t):t}const Nt=(t,e)=>{const n=t.__vccOpts||t;for(const[i,r]of e)n[i]=r;return n},jv={};function Uv(t,e){const n=Yt("router-view");return te(),bn(n)}const zv=Nt(jv,[["render",Uv]]);function Wv(t){return{all:t=t||new Map,on:function(e,n){var i=t.get(e);i?i.push(n):t.set(e,[n])},off:function(e,n){var i=t.get(e);i&&(n?i.splice(i.indexOf(n)>>>0,1):t.set(e,[]))},emit:function(e,n){var i=t.get(e);i&&i.slice().map(function(r){r(n)}),(i=t.get("*"))&&i.slice().map(function(r){r(e,n)})}}}const ys=Wv(),gh=new Map,fu={x:["left","center","right"],y:["top","bottom"]},Vv=(t=>()=>t++)(0),qv=t=>typeof t!="string"?[]:t.split(/\s+/gi).filter(e=>e),Gv=t=>{typeof t=="string"&&(t=qv(t));let e=null,n=null;return t.forEach(i=>{fu.y.indexOf(i)!==-1&&(n=i),fu.x.indexOf(i)!==-1&&(e=i)}),{x:e,y:n}};class Yv{constructor(e,n,i){this.remaining=n,this.callback=e,this.notifyItem=i,this.resume()}pause(){clearTimeout(this.notifyItem.timer),this.remaining-=Date.now()-this.start}resume(){this.start=Date.now(),clearTimeout(this.notifyItem.timer),this.notifyItem.timer=setTimeout(this.callback,this.remaining)}}var Po={position:["top","right"],cssAnimation:"vn-fade",velocityAnimation:{enter:t=>({height:[t.clientHeight,0],opacity:[1,0]}),leave:{height:0,opacity:[0,1]}}},wl=Pe({name:"velocity-group",emits:["after-leave","leave","enter"],methods:{enter(t,e){this.$emit("enter",t,e)},leave(t,e){this.$emit("leave",t,e)},afterLeave(){this.$emit("after-leave")}}});function Kv(t,e,n,i,r,s){return te(),bn(mh,{tag:"span",css:!1,onEnter:t.enter,onLeave:t.leave,onAfterLeave:t.afterLeave},{default:Ye(()=>[ht(t.$slots,"default")]),_:3},8,["onEnter","onLeave","onAfterLeave"])}wl.render=Kv;wl.__file="src/VelocityGroup.vue";var El=Pe({name:"css-group",inheritAttrs:!1,props:{name:{type:String,required:!0}}});function Qv(t,e,n,i,r,s){return te(),bn(mh,{tag:"span",name:t.name},{default:Ye(()=>[ht(t.$slots,"default")]),_:3},8,["name"])}El.render=Qv;El.__file="src/CssGroup.vue";const Mo="[-+]?[0-9]*.?[0-9]+",du=[{name:"px",regexp:new RegExp(`^${Mo}px$`)},{name:"%",regexp:new RegExp(`^${Mo}%$`)},{name:"px",regexp:new RegExp(`^${Mo}$`)}],Xv=t=>{if(t==="auto")return{type:t,value:0};for(let e=0;e<du.length;e++){const n=du[e];if(n.regexp.test(t))return{type:n.name,value:parseFloat(t)}}return{type:"",value:t}},Jv=t=>{switch(typeof t){case"number":return{type:"px",value:t};case"string":return Xv(t);default:return{type:"",value:t}}},Kr={IDLE:0,DESTROYED:2};var Cl=Pe({name:"notifications",components:{VelocityGroup:wl,CssGroup:El},props:{group:{type:String,default:""},width:{type:[Number,String],default:300},reverse:{type:Boolean,default:!1},position:{type:[String,Array],default:Po.position},classes:{type:String,default:"vue-notification"},animationType:{type:String,default:"css"},animation:{type:Object,default:Po.velocityAnimation},animationName:{type:String,default:Po.cssAnimation},speed:{type:Number,default:300},cooldown:{type:Number,default:0},duration:{type:Number,default:3e3},delay:{type:Number,default:0},max:{type:Number,default:1/0},ignoreDuplicates:{type:Boolean,default:!1},closeOnClick:{type:Boolean,default:!0},pauseOnHover:{type:Boolean,default:!1}},emits:["click","destroy"],data(){return{list:[],velocity:gh.get("velocity"),timerControl:null}},computed:{actualWidth(){return Jv(this.width)},isVA(){return this.animationType==="velocity"},componentName(){return this.isVA?"velocity-group":"css-group"},styles(){const{x:t,y:e}=Gv(this.position),n=this.actualWidth.value,i=this.actualWidth.type,r={width:n+i};return e&&(r[e]="0px"),t&&(t==="center"?r.left=`calc(50% - ${+n/2}${i})`:r[t]="0px"),r},active(){return this.list.filter(t=>t.state!==Kr.DESTROYED)},botToTop(){return this.styles.hasOwnProperty("bottom")}},mounted(){ys.on("add",this.addItem),ys.on("close",this.closeItem)},methods:{destroyIfNecessary(t){this.$emit("click",t),this.closeOnClick&&this.destroy(t)},pauseTimeout(){var t;this.pauseOnHover&&((t=this.timerControl)===null||t===void 0||t.pause())},resumeTimeout(){var t;this.pauseOnHover&&((t=this.timerControl)===null||t===void 0||t.resume())},addItem(t={}){if(t.group||(t.group=""),t.data||(t.data={}),this.group!==t.group)return;if(t.clean||t.clear){this.destroyAll();return}const e=typeof t.duration=="number"?t.duration:this.duration,n=typeof t.speed=="number"?t.speed:this.speed,i=typeof t.ignoreDuplicates=="boolean"?t.ignoreDuplicates:this.ignoreDuplicates,{title:r,text:s,type:o,data:a,id:l}=t,c={id:l||Vv(),title:r,text:s,type:o,state:Kr.IDLE,speed:n,length:e+2*n,data:a};e>=0&&(this.timerControl=new Yv(()=>this.destroy(c),c.length,c));const u=this.reverse?!this.botToTop:this.botToTop;let f=-1;const d=this.active.some(g=>g.title===t.title&&g.text===t.text);(!i||!d)&&(u?(this.list.push(c),this.active.length>this.max&&(f=0)):(this.list.unshift(c),this.active.length>this.max&&(f=this.active.length-1)),f!==-1&&this.destroy(this.active[f]))},closeItem(t){this.destroyById(t)},notifyClass(t){var e;return["vue-notification-template",this.classes,(e=t.type)!==null&&e!==void 0?e:""]},notifyWrapperStyle(t){return this.isVA?void 0:{transition:`all ${t.speed}ms`}},destroy(t){clearTimeout(t.timer),t.state=Kr.DESTROYED,this.clean(),this.$emit("destroy",t)},destroyById(t){const e=this.list.find(n=>n.id===t);e&&this.destroy(e)},destroyAll(){this.active.forEach(this.destroy)},getAnimation(t,e){var n;const i=(n=this.animation)===null||n===void 0?void 0:n[t];return typeof i=="function"?i.call(this,e):i},enter(t,e){if(!this.isVA)return;const n=this.getAnimation("enter",t);this.velocity(t,n,{duration:this.speed,complete:e})},leave(t,e){if(!this.isVA)return;const n=this.getAnimation("leave",t);this.velocity(t,n,{duration:this.speed,complete:e})},clean(){this.list=this.list.filter(t=>t.state!==Kr.DESTROYED)}}});const Zv=["data-id"],ey=["onClick"],ty=["innerHTML"],ny=["innerHTML"];function iy(t,e,n,i,r,s){return te(),he("div",{class:"vue-notification-group",style:ar(t.styles)},[(te(),bn(R_(t.componentName),{name:t.animationName,onEnter:t.enter,onLeave:t.leave,onAfterLeave:t.clean},{default:Ye(()=>[(te(!0),he(je,null,ml(t.active,o=>(te(),he("div",{key:o.id,class:"vue-notification-wrapper",style:ar(t.notifyWrapperStyle(o)),"data-id":o.id,onMouseenter:e[0]||(e[0]=(...a)=>t.pauseTimeout&&t.pauseTimeout(...a)),onMouseleave:e[1]||(e[1]=(...a)=>t.resumeTimeout&&t.resumeTimeout(...a))},[ht(t.$slots,"body",{class:qe([t.classes,o.type]),item:o,close:()=>t.destroy(o)},()=>[Lt(" Default slot template "),D("div",{class:qe(t.notifyClass(o)),onClick:a=>t.destroyIfNecessary(o)},[o.title?(te(),he("div",{key:0,class:"notification-title",innerHTML:o.title},null,8,ty)):Lt("v-if",!0),D("div",{class:"notification-content",innerHTML:o.text},null,8,ny)],10,ey)])],44,Zv))),128))]),_:3},40,["name","onEnter","onLeave","onAfterLeave"]))],4)}function ry(t,e){e===void 0&&(e={});var n=e.insertAt;if(!(!t||typeof document>"u")){var i=document.head||document.getElementsByTagName("head")[0],r=document.createElement("style");r.type="text/css",n==="top"&&i.firstChild?i.insertBefore(r,i.firstChild):i.appendChild(r),r.styleSheet?r.styleSheet.cssText=t:r.appendChild(document.createTextNode(t))}}var sy=`
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const $0="FirebaseError";class ii extends Error{constructor(e,n,i){super(n),this.code=e,this.customData=i,this.name=$0,Object.setPrototypeOf(this,ii.prototype),Error.captureStackTrace&&Error.captureStackTrace(this,uo.prototype.create)}}class uo{constructor(e,n,i){this.service=e,this.serviceName=n,this.errors=i}create(e,...n){const i=n[0]||{},r=`${this.service}/${e}`,s=this.errors[e],o=s?B0(s,i):"Error",a=`${this.serviceName}: ${o} (${r}).`;return new ii(r,a,i)}}function B0(t,e){return t.replace(H0,(n,i)=>{const r=e[i];return r!=null?String(r):`<${i}?>`})}const H0=/\{\$([^}]+)}/g;/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function wr(t){return JSON.parse(t)}function De(t){return JSON.stringify(t)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const ip=function(t){let e={},n={},i={},r="";try{const s=t.split(".");e=wr(Aa(s[0])||""),n=wr(Aa(s[1])||""),r=s[2],i=n.d||{},delete n.d}catch{}return{header:e,claims:n,data:i,signature:r}},j0=function(t){const e=ip(t),n=e.claims;return!!n&&typeof n=="object"&&n.hasOwnProperty("iat")},U0=function(t){const e=ip(t).claims;return typeof e=="object"&&e.admin===!0};/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class p1{constructor(e){this.container=e}getPlatformInfoString(){return this.container.getProviders().map(n=>{if(m1(n)){const i=n.getImmediate();return`${i.library}/${i.version}`}else return null}).filter(n=>n).join(" ")}}function m1(t){const e=t.getComponent();return(e==null?void 0:e.type)==="VERSION"}const Ra="@firebase/app",Gu="0.8.0";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const As=new Map,Pa=new Map;function U1(t,e){try{t.container.addComponent(e)}catch(n){Xn.debug(`Component ${e.name} failed to register with FirebaseApp ${t.name}`,n)}}function In(t){const e=t.name;if(Pa.has(e))return Xn.debug(`There were multiple attempts to register component ${e}.`),!1;Pa.set(e,t);for(const n of As.values())U1(n,t);return!0}function Dr(t,e){const n=t.container.getProvider("heartbeat").getImmediate({optional:!0});return n&&n.triggerHeartbeat(),t.container.getProvider(e)}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const V1=H1;function ap(t,e={}){let n=t;typeof e!="object"&&(e={name:e});const i=Object.assign({name:Oa,automaticDataCollectionEnabled:!1},e),r=i.name;if(typeof r!="string"||!r)throw gn.create("bad-app-name",{appName:String(r)});if(n||(n=L0()),!n)throw gn.create("no-options");const s=As.get(r);if(s){if(Ss(n,s.options)&&Ss(i,s.config))return s;throw gn.create("duplicate-app",{appName:r})}const o=new Z0(r);for(const l of Pa.values())o.addComponent(l);const a=new W1(n,i,o);return As.set(r,a),a}function lp(t=Oa){const e=As.get(t);if(!e&&t===Oa)return ap();if(!e)throw gn.create("no-app",{appName:t});return e}function $t(t,e,n){var i;let r=(i=j1[t])!==null&&i!==void 0?i:t;n&&(r+=`-${n}`);const s=r.match(/\s|\//),o=e.match(/\s|\//);if(s||o){const a=[`Unable to register library "${r}" with version "${e}":`];s&&a.push(`library name "${r}" contains illegal characters (whitespace or "/")`),s&&o&&a.push("and"),o&&a.push(`version name "${e}" contains illegal characters (whitespace or "/")`),Xn.warn(a.join(" "));return}In(new Jt(`${r}-version`,()=>({library:r,version:e}),"VERSION"))}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function ew(t){In(new Jt("platform-logger",e=>new p1(e),"PRIVATE")),In(new Jt("heartbeat",e=>new X1(e),"PRIVATE")),$t(Ra,Gu,t),$t(Ra,Gu,"esm2017"),$t("fire-js","")}ew("");var tw="firebase",nw="9.11.0";/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */$t(tw,nw,"app");const fp="@firebase/installations",zl="0.5.13";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const hw=/^[cdef][\w-]{21}$/,Ma="";function pw(){try{const t=new Uint8Array(17);(self.crypto||self.msCrypto).getRandomValues(t),t[0]=112+t[0]%16;const n=mw(t);return hw.test(n)?n:Ma}catch{return Ma}}function mw(t){return dw(t).substr(0,22)}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Ep=new Map;function Cp(t,e){const n=ho(t);xp(n,e),gw(n,e)}function xp(t,e){const n=Ep.get(t);if(!!n)for(const i of n)i(e)}function gw(t,e){const n=_w();n&&n.postMessage({key:t,fid:e}),vw()}let Un=null;function _w(){return!Un&&"BroadcastChannel"in self&&(Un=new BroadcastChannel("[Firebase] FID Change"),Un.onmessage=t=>{xp(t.data.key,t.data.fid)}),Un}function vw(){Ep.size===0&&Un&&(Un.close(),Un=null)}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const yw="firebase-installations-database",bw=1,Zn="firebase-installations-store";let zo=null;function Wl(){return zo||(zo=op(yw,bw,{upgrade:(t,e)=>{switch(e){case 0:t.createObjectStore(Zn)}}})),zo}async function ks(t,e){const n=ho(t),r=(await Wl()).transaction(Zn,"readwrite"),s=r.objectStore(Zn),o=await s.get(n);return await s.put(e,n),await r.done,(!o||o.fid!==e.fid)&&Cp(t,e.fid),e}async function Ip(t){const e=ho(t),i=(await Wl()).transaction(Zn,"readwrite");await i.objectStore(Zn).delete(e),await i.done}async function po(t,e){const n=ho(t),r=(await Wl()).transaction(Zn,"readwrite"),s=r.objectStore(Zn),o=await s.get(n),a=e(o);return a===void 0?await s.delete(n):await s.put(a,n),await r.done,a&&(!o||o.fid!==a.fid)&&Cp(t,a.fid),a}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Fw(t){if(!t||!t.options)throw Wo("App Configuration");if(!t.name)throw Wo("App Name");const e=["projectId","apiKey","appId"];for(const n of e)if(!t.options[n])throw Wo(n);return{appName:t.name,projectId:t.options.projectId,apiKey:t.options.apiKey,appId:t.options.appId}}function Wo(t){return Jn.create("missing-app-config-values",{valueName:t})}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class dE{constructor(e){this.app=e}_delete(){return delete er[this.app.options.appId],Promise.resolve()}}let er={},Zu=[];const ef={};let Vo="dataLayer",hE="gtag",tf,Pp,nf=!1;function pE(){const t=[];if(A0()&&t.push("This is a browser extension environment."),N0()||t.push("Cookies are not available."),t.length>0){const e=t.map((i,r)=>`(${r+1}) ${i}`).join(" "),n=gt.create("invalid-analytics-context",{errorInfo:e});ct.warn(n.message)}}function mE(t,e,n){pE();const i=t.options.appId;if(!i)throw gt.create("no-app-id");if(!t.options.apiKey)if(t.options.measurementId)ct.warn(`The "apiKey" field is empty in the local Firebase config. This is needed to fetch the latest measurement ID for this Firebase app. Falling back to the measurement ID ${t.options.measurementId} provided in the "measurementId" field in the local Firebase config.`);else throw gt.create("no-api-key");if(er[i]!=null)throw gt.create("already-exists",{id:i});if(!nf){Gw(Vo);const{wrappedGtag:s,gtagCore:o}=Xw(er,Zu,ef,Vo,hE);Pp=s,tf=o,nf=!0}return er[i]=fE(t,Zu,ef,e,tf,Vo,n),new dE(t)}function gE(t=lp()){t=kn(t);const e=Dr(t,Ns);return e.isInitialized()?e.getImmediate():_E(t)}function _E(t,e={}){const n=Dr(t,Ns);if(n.isInitialized()){const r=n.getImmediate();if(Ss(e,n.getOptions()))return r;throw gt.create("already-initialized")}return n.initialize({options:e})}function vE(t,e,n,i){t=kn(t),cE(Pp,er[t.app.options.appId],e,n,i).catch(r=>ct.error(r))}const rf="@firebase/analytics",sf="0.8.1";function yE(){In(new Jt(Ns,(e,{options:n})=>{const i=e.getProvider("app").getImmediate(),r=e.getProvider("installations-internal").getImmediate();return mE(i,r,n)},"PUBLIC")),In(new Jt("analytics-internal",t,"PRIVATE")),$t(rf,sf),$t(rf,sf,"esm2017");function t(e){try{const n=e.getProvider(Ns).getImmediate();return{logEvent:(i,r,s)=>vE(n,i,r,s)}}catch(n){throw gt.create("interop-component-reg-failed",{reason:n})}}}yE();const of="@firebase/database",af="0.13.7";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Dp=function(t){try{if(typeof window<"u"&&typeof window[t]<"u"){const e=window[t];return e.setItem("firebase:sentinel","cache"),e.removeItem("firebase:sentinel"),new wE(e)}}catch{}return new EE},zn=Dp("localStorage"),Da=Dp("sessionStorage");/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class DE{constructor(e,n){this.appName_=e,this.appCheckProvider=n,this.appCheck=n==null?void 0:n.getImmediate({optional:!0}),this.appCheck||n==null||n.get().then(i=>this.appCheck=i)}getToken(e){return this.appCheck?this.appCheck.getToken(e):new Promise((n,i)=>{setTimeout(()=>{this.appCheck?this.getToken(e).then(n,i):n(null)},0)})}addTokenChangeListener(e){var n;(n=this.appCheckProvider)===null||n===void 0||n.get().then(i=>i.addTokenListener(e))}notifyForInvalidToken(){st(`Provided AppCheck credentials for the app named "${this.appName_}" are invalid. This usually indicates your app was not initialized correctly.`)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class LE{constructor(e,n,i){this.appName_=e,this.firebaseOptions_=n,this.authProvider_=i,this.auth_=null,this.auth_=i.getImmediate({optional:!0}),this.auth_||i.onInit(r=>this.auth_=r)}getToken(e){return this.auth_?this.auth_.getToken(e).catch(n=>n&&n.code==="auth/token-not-initialized"?(Ke("Got auth/token-not-initialized error.  Treating as null token."),null):Promise.reject(n)):new Promise((n,i)=>{setTimeout(()=>{this.auth_?this.getToken(e).then(n,i):n(null)},0)})}addTokenChangeListener(e){this.auth_?this.auth_.addAuthTokenListener(e):this.authProvider_.get().then(n=>n.addAuthTokenListener(e))}removeTokenChangeListener(e){this.authProvider_.get().then(n=>n.removeAuthTokenListener(e))}notifyForInvalidToken(){let e='Provided authentication credentials for the app named "'+this.appName_+'" are invalid. This usually indicates your app was not initialized correctly. ';"credential"in this.firebaseOptions_?e+='Make sure the "credential" property provided to initializeApp() is authorized to access the specified "databaseURL" and is from the correct project.':"serviceAccount"in this.firebaseOptions_?e+='Make sure the "serviceAccount" property provided to initializeApp() is authorized to access the specified "databaseURL" and is from the correct project.':e+='Make sure the "apiKey" and "databaseURL" properties provided to initializeApp() match the values provided for your app at https://console.firebase.google.com/.',st(e)}}class bi{constructor(e){this.accessToken=e}getToken(e){return Promise.resolve({accessToken:this.accessToken})}addTokenChangeListener(e){e(this.accessToken)}removeTokenChangeListener(e){}notifyForInvalidToken(){}}bi.OWNER="owner";/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Yl="5",Hp="v",jp="s",Up="r",zp="f",Wp=/(console\.firebase|firebase-console-\w+\.corp|firebase\.corp)\.google\.com/,Vp="ls",qp="p",Fa="ac",Gp="websocket",Yp="long_polling";/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const qo={},Go={};function Kl(t){const e=t.toString();return qo[e]||(qo[e]=new $E),qo[e]}function BE(t,e){const n=t.toString();return Go[n]||(Go[n]=e()),Go[n]}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const _f=32,vf=768;class pe{constructor(e,n){if(n===void 0){this.pieces_=e.split("/");let i=0;for(let r=0;r<this.pieces_.length;r++)this.pieces_[r].length>0&&(this.pieces_[i]=this.pieces_[r],i++);this.pieces_.length=i,this.pieceNum_=0}else this.pieces_=e,this.pieceNum_=n}toString(){let e="";for(let n=this.pieceNum_;n<this.pieces_.length;n++)this.pieces_[n]!==""&&(e+="/"+this.pieces_[n]);return e||"/"}}function se(){return new pe("")}function ee(t){return t.pieceNum_>=t.pieces_.length?null:t.pieces_[t.pieceNum_]}function Tn(t){return t.pieces_.length-t.pieceNum_}function ye(t){let e=t.pieceNum_;return e<t.pieces_.length&&e++,new pe(t.pieces_,e)}function rm(t){return t.pieceNum_<t.pieces_.length?t.pieces_[t.pieces_.length-1]:null}function lC(t){let e="";for(let n=t.pieceNum_;n<t.pieces_.length;n++)t.pieces_[n]!==""&&(e+="/"+encodeURIComponent(String(t.pieces_[n])));return e||"/"}function sm(t,e=0){return t.pieces_.slice(t.pieceNum_+e)}function om(t){if(t.pieceNum_>=t.pieces_.length)return null;const e=[];for(let n=t.pieceNum_;n<t.pieces_.length-1;n++)e.push(t.pieces_[n]);return new pe(e,0)}function Le(t,e){const n=[];for(let i=t.pieceNum_;i<t.pieces_.length;i++)n.push(t.pieces_[i]);if(e instanceof pe)for(let i=e.pieceNum_;i<e.pieces_.length;i++)n.push(e.pieces_[i]);else{const i=e.split("/");for(let r=0;r<i.length;r++)i[r].length>0&&n.push(i[r])}return new pe(n,0)}function J(t){return t.pieceNum_>=t.pieces_.length}function et(t,e){const n=ee(t),i=ee(e);if(n===null)return e;if(n===i)return et(ye(t),ye(e));throw new Error("INTERNAL ERROR: innerPath ("+e+") is not within outerPath ("+t+")")}function am(t,e){if(Tn(t)!==Tn(e))return!1;for(let n=t.pieceNum_,i=e.pieceNum_;n<=t.pieces_.length;n++,i++)if(t.pieces_[n]!==e.pieces_[i])return!1;return!0}function It(t,e){let n=t.pieceNum_,i=e.pieceNum_;if(Tn(t)>Tn(e))return!1;for(;n<t.pieces_.length;){if(t.pieces_[n]!==e.pieces_[i])return!1;++n,++i}return!0}class cC{constructor(e,n){this.errorPrefix_=n,this.parts_=sm(e,0),this.byteLength_=Math.max(1,this.parts_.length);for(let i=0;i<this.parts_.length;i++)this.byteLength_+=fo(this.parts_[i]);lm(this)}}function uC(t,e){t.parts_.length>0&&(t.byteLength_+=1),t.parts_.push(e),t.byteLength_+=fo(e),lm(t)}function fC(t){const e=t.parts_.pop();t.byteLength_-=fo(e),t.parts_.length>0&&(t.byteLength_-=1)}function lm(t){if(t.byteLength_>vf)throw new Error(t.errorPrefix_+"has a key path longer than "+vf+" bytes ("+t.byteLength_+").");if(t.parts_.length>_f)throw new Error(t.errorPrefix_+"path specified exceeds the maximum depth that can be written ("+_f+") or object contains a cycle "+Ln(t))}function Ln(t){return t.parts_.length===0?"":"in property '"+t.parts_.join(".")+"'"}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let $a;function vC(t){$a=t}const um=function(t){return typeof t=="number"?"number:"+Bp(t):"string:"+t},fm=function(t){if(t.isLeafNode()){const e=t.val();S(typeof e=="string"||typeof e=="number"||typeof e=="object"&&nn(e,".sv"),"Priority must be a string or number.")}else S(t===$a||t.isEmpty(),"priority of unexpected type.");S(t===$a||t.getPriority().isEmpty(),"Priority nodes can't have a priority of their own.")};/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let wf;class Be{constructor(e,n=Be.__childrenNodeConstructor.EMPTY_NODE){this.value_=e,this.priorityNode_=n,this.lazyHash_=null,S(this.value_!==void 0&&this.value_!==null,"LeafNode shouldn't be created with null/undefined value."),fm(this.priorityNode_)}static set __childrenNodeConstructor(e){wf=e}static get __childrenNodeConstructor(){return wf}isLeafNode(){return!0}getPriority(){return this.priorityNode_}updatePriority(e){return new Be(this.value_,e)}getImmediateChild(e){return e===".priority"?this.priorityNode_:Be.__childrenNodeConstructor.EMPTY_NODE}getChild(e){return J(e)?this:ee(e)===".priority"?this.priorityNode_:Be.__childrenNodeConstructor.EMPTY_NODE}hasChild(){return!1}getPredecessorChildName(e,n){return null}updateImmediateChild(e,n){return e===".priority"?this.updatePriority(n):n.isEmpty()&&e!==".priority"?this:Be.__childrenNodeConstructor.EMPTY_NODE.updateImmediateChild(e,n).updatePriority(this.priorityNode_)}updateChild(e,n){const i=ee(e);return i===null?n:n.isEmpty()&&i!==".priority"?this:(S(i!==".priority"||Tn(e)===1,".priority must be the last token in a path"),this.updateImmediateChild(i,Be.__childrenNodeConstructor.EMPTY_NODE.updateChild(ye(e),n)))}isEmpty(){return!1}numChildren(){return 0}forEachChild(e,n){return!1}val(e){return e&&!this.getPriority().isEmpty()?{".value":this.getValue(),".priority":this.getPriority().val()}:this.getValue()}hash(){if(this.lazyHash_===null){let e="";this.priorityNode_.isEmpty()||(e+="priority:"+um(this.priorityNode_.val())+":");const n=typeof this.value_;e+=n+":",n==="number"?e+=Bp(this.value_):e+=this.value_,this.lazyHash_=Lp(e)}return this.lazyHash_}getValue(){return this.value_}compareTo(e){return e===Be.__childrenNodeConstructor.EMPTY_NODE?1:e instanceof Be.__childrenNodeConstructor?-1:(S(e.isLeafNode(),"Unknown node type"),this.compareToLeafNode_(e))}compareToLeafNode_(e){const n=typeof e.value_,i=typeof this.value_,r=Be.VALUE_TYPE_ORDER.indexOf(n),s=Be.VALUE_TYPE_ORDER.indexOf(i);return S(r>=0,"Unknown leaf type: "+n),S(s>=0,"Unknown leaf type: "+i),r===s?i==="object"?0:this.value_<e.value_?-1:this.value_===e.value_?0:1:s-r}withIndex(){return this}isIndexed(){return!0}equals(e){if(e===this)return!0;if(e.isLeafNode()){const n=e;return this.value_===n.value_&&this.priorityNode_.equals(n.priorityNode_)}else return!1}}Be.VALUE_TYPE_ORDER=["object","boolean","number","string"];/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let dm,hm;function yC(t){dm=t}function bC(t){hm=t}class wC extends mo{compare(e,n){const i=e.node.getPriority(),r=n.node.getPriority(),s=i.compareTo(r);return s===0?Fi(e.name,n.name):s}isDefinedOn(e){return!e.getPriority().isEmpty()}indexedValueChanged(e,n){return!e.getPriority().equals(n.getPriority())}minPost(){return X.MIN}maxPost(){return new X(ei,new Be("[PRIORITY-POST]",hm))}makePost(e,n){const i=dm(e);return new X(n,new Be("[PRIORITY-POST]",i))}toString(){return".priority"}}const ke=new wC;/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const IC=!0;function Ue(t,e=null){if(t===null)return z.EMPTY_NODE;if(typeof t=="object"&&".priority"in t&&(e=t[".priority"]),S(e===null||typeof e=="string"||typeof e=="number"||typeof e=="object"&&".sv"in e,"Invalid priority type found: "+typeof e),typeof t=="object"&&".value"in t&&t[".value"]!==null&&(t=t[".value"]),typeof t!="object"||".sv"in t){const n=t;return new Be(n,Ue(e))}if(!(t instanceof Array)&&IC){const n=[];let i=!1;if(ot(t,(o,a)=>{if(o.substring(0,1)!=="."){const l=Ue(a);l.isEmpty()||(i=i||!l.getPriority().isEmpty(),n.push(new X(o,l)))}}),n.length===0)return z.EMPTY_NODE;const s=Ps(n,_C,o=>o.name,Jl);if(i){const o=Ps(n,ke.getCompare());return new z(s,Ue(e),new Wt({".priority":o},{".priority":ke}))}else return new z(s,Ue(e),Wt.Default)}else{let n=z.EMPTY_NODE;return ot(t,(i,r)=>{if(nn(t,i)&&i.substring(0,1)!=="."){const s=Ue(r);(s.isLeafNode()||!s.isEmpty())&&(n=n.updateImmediateChild(i,s))}}),n.updatePriority(Ue(e))}}yC(Ue);/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class SC extends mo{compare(e,n){const i=e.node.compareTo(n.node);return i===0?Fi(e.name,n.name):i}isDefinedOn(e){return!0}indexedValueChanged(e,n){return!e.equals(n)}minPost(){return X.MIN}maxPost(){return X.MAX}makePost(e,n){const i=Ue(e);return new X(n,i)}toString(){return".value"}}const AC=new SC;/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class MC{constructor(e){this.collection_=e,this.last_=null}get(){const e=this.collection_.get(),n=Object.assign({},e);return this.last_&&ot(this.last_,(i,r)=>{n[i]=n[i]-r}),this.last_=e,n}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function go(t,e){return{eventCache:t,serverCache:e}}function nr(t,e,n,i){return go(new Sn(e,n,i),t.serverCache)}function _m(t,e,n,i){return go(t.eventCache,new Sn(e,n,i))}function Fs(t){return t.eventCache.isFullyInitialized()?t.eventCache.getNode():null}function ni(t){return t.serverCache.isFullyInitialized()?t.serverCache.getNode():null}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class At{constructor(e){this.writeTree_=e}static empty(){return new At(new we(null))}}function ir(t,e,n){if(J(e))return new At(new we(n));{const i=t.writeTree_.findRootMostValueAndPath(e);if(i!=null){const r=i.path;let s=i.value;const o=et(r,e);return s=s.updateChild(o,n),new At(t.writeTree_.set(r,s))}else{const r=new we(n),s=t.writeTree_.setTree(e,r);return new At(s)}}}function If(t,e,n){let i=t;return ot(n,(r,s)=>{i=ir(i,Le(e,r),s)}),i}function Tf(t,e){if(J(e))return At.empty();{const n=t.writeTree_.setTree(e,new we(null));return new At(n)}}function Ha(t,e){return ri(t,e)!=null}function ri(t,e){const n=t.writeTree_.findRootMostValueAndPath(e);return n!=null?t.writeTree_.get(n.path).getChild(et(n.path,e)):null}function Sf(t){const e=[],n=t.writeTree_.value;return n!=null?n.isLeafNode()||n.forEachChild(ke,(i,r)=>{e.push(new X(i,r))}):t.writeTree_.children.inorderTraversal((i,r)=>{r.value!=null&&e.push(new X(i,r.value))}),e}function _n(t,e){if(J(e))return t;{const n=ri(t,e);return n!=null?new At(new we(n)):new At(t.writeTree_.subtree(e))}}function ja(t){return t.writeTree_.isEmpty()}function Ai(t,e){return vm(se(),t.writeTree_,e)}function vm(t,e,n){if(e.value!=null)return n.updateChild(t,e.value);{let i=null;return e.children.inorderTraversal((r,s)=>{r===".priority"?(S(s.value!==null,"Priority writes must always be leaf nodes"),i=s.value):n=vm(Le(t,r),s,n)}),!n.getChild(t).isEmpty()&&i!==null&&(n=n.updateChild(Le(t,".priority"),i)),n}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function _o(t,e){return Em(e,t)}function zC(t,e,n,i,r){S(i>t.lastWriteId,"Stacking an older write on top of newer ones"),r===void 0&&(r=!0),t.allWrites.push({path:e,snap:n,writeId:i,visible:r}),r&&(t.visibleWrites=ir(t.visibleWrites,e,n)),t.lastWriteId=i}function WC(t,e){for(let n=0;n<t.allWrites.length;n++){const i=t.allWrites[n];if(i.writeId===e)return i}return null}function VC(t,e){const n=t.allWrites.findIndex(a=>a.writeId===e);S(n>=0,"removeWrite called with nonexistent writeId.");const i=t.allWrites[n];t.allWrites.splice(n,1);let r=i.visible,s=!1,o=t.allWrites.length-1;for(;r&&o>=0;){const a=t.allWrites[o];a.visible&&(o>=n&&qC(a,i.path)?r=!1:It(i.path,a.path)&&(s=!0)),o--}if(r){if(s)return GC(t),!0;if(i.snap)t.visibleWrites=Tf(t.visibleWrites,i.path);else{const a=i.children;ot(a,l=>{t.visibleWrites=Tf(t.visibleWrites,Le(i.path,l))})}return!0}else return!1}function qC(t,e){if(t.snap)return It(t.path,e);for(const n in t.children)if(t.children.hasOwnProperty(n)&&It(Le(t.path,n),e))return!0;return!1}function GC(t){t.visibleWrites=ym(t.allWrites,YC,se()),t.allWrites.length>0?t.lastWriteId=t.allWrites[t.allWrites.length-1].writeId:t.lastWriteId=-1}function YC(t){return t.visible}function ym(t,e,n){let i=At.empty();for(let r=0;r<t.length;++r){const s=t[r];if(e(s)){const o=s.path;let a;if(s.snap)It(n,o)?(a=et(n,o),i=ir(i,a,s.snap)):It(o,n)&&(a=et(o,n),i=ir(i,se(),s.snap.getChild(a)));else if(s.children){if(It(n,o))a=et(n,o),i=If(i,a,s.children);else if(It(o,n))if(a=et(o,n),J(a))i=If(i,se(),s.children);else{const l=Ii(s.children,ee(a));if(l){const c=l.getChild(ye(a));i=ir(i,se(),c)}}}else throw Li("WriteRecord should have .snap or .children")}}return i}function bm(t,e,n,i,r){if(!i&&!r){const s=ri(t.visibleWrites,e);if(s!=null)return s;{const o=_n(t.visibleWrites,e);if(ja(o))return n;if(n==null&&!Ha(o,se()))return null;{const a=n||z.EMPTY_NODE;return Ai(o,a)}}}else{const s=_n(t.visibleWrites,e);if(!r&&ja(s))return n;if(!r&&n==null&&!Ha(s,se()))return null;{const o=function(c){return(c.visible||r)&&(!i||!~i.indexOf(c.writeId))&&(It(c.path,e)||It(e,c.path))},a=ym(t.allWrites,o,e),l=n||z.EMPTY_NODE;return Ai(a,l)}}}function KC(t,e,n){let i=z.EMPTY_NODE;const r=ri(t.visibleWrites,e);if(r)return r.isLeafNode()||r.forEachChild(ke,(s,o)=>{i=i.updateImmediateChild(s,o)}),i;if(n){const s=_n(t.visibleWrites,e);return n.forEachChild(ke,(o,a)=>{const l=Ai(_n(s,new pe(o)),a);i=i.updateImmediateChild(o,l)}),Sf(s).forEach(o=>{i=i.updateImmediateChild(o.name,o.node)}),i}else{const s=_n(t.visibleWrites,e);return Sf(s).forEach(o=>{i=i.updateImmediateChild(o.name,o.node)}),i}}function QC(t,e,n,i,r){S(i||r,"Either existingEventSnap or existingServerSnap must exist");const s=Le(e,n);if(Ha(t.visibleWrites,s))return null;{const o=_n(t.visibleWrites,s);return ja(o)?r.getChild(n):Ai(o,r.getChild(n))}}function XC(t,e,n,i){const r=Le(e,n),s=ri(t.visibleWrites,r);if(s!=null)return s;if(i.isCompleteForChild(n)){const o=_n(t.visibleWrites,r);return Ai(o,i.getNode().getImmediateChild(n))}else return null}function JC(t,e){return ri(t.visibleWrites,e)}function ZC(t,e,n,i,r,s,o){let a;const l=_n(t.visibleWrites,e),c=ri(l,se());if(c!=null)a=c;else if(n!=null)a=Ai(l,n);else return[];if(a=a.withIndex(o),!a.isEmpty()&&!a.isLeafNode()){const u=[],f=o.getCompare(),d=s?a.getReverseIteratorFrom(i,o):a.getIteratorFrom(i,o);let p=d.getNext();for(;p&&u.length<r;)f(p,i)!==0&&u.push(p),p=d.getNext();return u}else return[]}function ex(){return{visibleWrites:At.empty(),allWrites:[],lastWriteId:-1}}function $s(t,e,n,i){return bm(t.writeTree,t.treePath,e,n,i)}function ic(t,e){return KC(t.writeTree,t.treePath,e)}function Af(t,e,n,i){return QC(t.writeTree,t.treePath,e,n,i)}function Bs(t,e){return JC(t.writeTree,Le(t.treePath,e))}function tx(t,e,n,i,r,s){return ZC(t.writeTree,t.treePath,e,n,i,r,s)}function rc(t,e,n){return XC(t.writeTree,t.treePath,e,n)}function wm(t,e){return Em(Le(t.treePath,e),t.writeTree)}function Em(t,e){return{treePath:t,writeTree:e}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let Us;function Cx(t){S(!Us,"__referenceConstructor has already been defined"),Us=t}function xx(){return S(Us,"Reference.ts has not been loaded"),Us}let Ix=1;class Mf{constructor(e){this.listenProvider_=e,this.syncPointTree_=new we(null),this.pendingWriteTree_=ex(),this.tagToQueryMap=new Map,this.queryToTagMap=new Map}}function Rm(t,e,n,i,r){return zC(t.pendingWriteTree_,e,n,i,r),r?Hr(t,new ti(gm(),e,n)):[]}function Wn(t,e,n=!1){const i=WC(t.pendingWriteTree_,e);if(VC(t.pendingWriteTree_,e)){let s=new we(null);return i.snap!=null?s=s.set(se(),!0):ot(i.children,o=>{s=s.set(new pe(o),!0)}),Hr(t,new Ls(i.path,s,n))}else return[]}function Br(t,e,n){return Hr(t,new ti(tc(),e,n))}function Tx(t,e,n){const i=we.fromObject(n);return Hr(t,new Ar(tc(),e,i))}function Sx(t,e){return Hr(t,new Sr(tc(),e))}function Ax(t,e,n){const i=lc(t,n);if(i){const r=cc(i),s=r.path,o=r.queryId,a=et(s,e),l=new Sr(nc(o),a);return uc(t,s,l)}else return[]}function Om(t,e,n,i,r=!1){const s=e._path,o=t.syncPointTree_.get(s);let a=[];if(o&&(e._queryIdentifier==="default"||Nm(o,e))){const l=Ex(o,e,n,i);bx(o)&&(t.syncPointTree_=t.syncPointTree_.remove(s));const c=l.removed;if(a=l.events,!r){const u=c.findIndex(d=>d._queryParams.loadsAllData())!==-1,f=t.syncPointTree_.findOnPath(s,(d,p)=>An(p));if(u&&!f){const d=t.syncPointTree_.subtree(s);if(!d.isEmpty()){const p=Ox(d);for(let g=0;g<p.length;++g){const b=p[g],I=b.query,_=Lm(t,b);t.listenProvider_.startListening(rr(I),kr(t,I),_.hashFn,_.onComplete)}}}!f&&c.length>0&&!i&&(u?t.listenProvider_.stopListening(rr(e),null):c.forEach(d=>{const p=t.queryToTagMap.get(yo(d));t.listenProvider_.stopListening(rr(d),p)}))}Px(t,c)}return a}function Pm(t,e,n,i){const r=lc(t,i);if(r!=null){const s=cc(r),o=s.path,a=s.queryId,l=et(o,e),c=new ti(nc(a),l,n);return uc(t,o,c)}else return[]}function kx(t,e,n,i){const r=lc(t,i);if(r){const s=cc(r),o=s.path,a=s.queryId,l=et(o,e),c=we.fromObject(n),u=new Ar(nc(a),l,c);return uc(t,o,u)}else return[]}function Nx(t,e,n,i=!1){const r=e._path;let s=null,o=!1;t.syncPointTree_.foreachOnPath(r,(d,p)=>{const g=et(d,r);s=s||vn(p,g),o=o||An(p)});let a=t.syncPointTree_.get(r);a?(o=o||An(a),s=s||vn(a,se())):(a=new Tm,t.syncPointTree_=t.syncPointTree_.set(r,a));let l;s!=null?l=!0:(l=!1,s=z.EMPTY_NODE,t.syncPointTree_.subtree(r).foreachChild((p,g)=>{const b=vn(g,se());b&&(s=s.updateImmediateChild(p,b))}));const c=Nm(a,e);if(!c&&!e._queryParams.loadsAllData()){const d=yo(e);S(!t.queryToTagMap.has(d),"View does not exist, but we have a tag");const p=Mx();t.queryToTagMap.set(d,p),t.tagToQueryMap.set(p,d)}const u=_o(t.pendingWriteTree_,r);let f=wx(a,e,n,u,s,l);if(!c&&!o&&!i){const d=km(a,e);f=f.concat(Dx(t,e,d))}return f}function ac(t,e,n){const r=t.pendingWriteTree_,s=t.syncPointTree_.findOnPath(e,(o,a)=>{const l=et(o,e),c=vn(a,l);if(c)return c});return bm(r,e,s,n,!0)}function Rx(t,e){const n=e._path;let i=null;t.syncPointTree_.foreachOnPath(n,(c,u)=>{const f=et(c,n);i=i||vn(u,f)});let r=t.syncPointTree_.get(n);r?i=i||vn(r,se()):(r=new Tm,t.syncPointTree_=t.syncPointTree_.set(n,r));const s=i!=null,o=s?new Sn(i,!0,!1):null,a=_o(t.pendingWriteTree_,e._path),l=Sm(r,e,a,s?o.getNode():z.EMPTY_NODE,s);return px(l)}function Hr(t,e){return Mm(e,t.syncPointTree_,null,_o(t.pendingWriteTree_,se()))}function Mm(t,e,n,i){if(J(t.path))return Dm(t,e,n,i);{const r=e.get(se());n==null&&r!=null&&(n=vn(r,se()));let s=[];const o=ee(t.path),a=t.operationForChild(o),l=e.children.get(o);if(l&&a){const c=n?n.getImmediateChild(o):null,u=wm(i,o);s=s.concat(Mm(a,l,c,u))}return r&&(s=s.concat(oc(r,t,i,n))),s}}function Dm(t,e,n,i){const r=e.get(se());n==null&&r!=null&&(n=vn(r,se()));let s=[];return e.children.inorderTraversal((o,a)=>{const l=n?n.getImmediateChild(o):null,c=wm(i,o),u=t.operationForChild(o);u&&(s=s.concat(Dm(u,a,l,c)))}),r&&(s=s.concat(oc(r,t,i,n))),s}function Lm(t,e){const n=e.query,i=kr(t,n);return{hashFn:()=>(hx(e)||z.EMPTY_NODE).hash(),onComplete:r=>{if(r==="ok")return i?Ax(t,n._path,i):Sx(t,n._path);{const s=NE(r,n);return Om(t,n,null,s)}}}}function kr(t,e){const n=yo(e);return t.queryToTagMap.get(n)}function yo(t){return t._path.toString()+"$"+t._queryIdentifier}function lc(t,e){return t.tagToQueryMap.get(e)}function cc(t){const e=t.indexOf("$");return S(e!==-1&&e<t.length-1,"Bad queryKey."),{queryId:t.substr(e+1),path:new pe(t.substr(0,e))}}function uc(t,e,n){const i=t.syncPointTree_.get(e);S(i,"Missing sync point for query tag that we're tracking");const r=_o(t.pendingWriteTree_,e);return oc(i,n,r,null)}function Ox(t){return t.fold((e,n,i)=>{if(n&&An(n))return[vo(n)];{let r=[];return n&&(r=Am(n)),ot(i,(s,o)=>{r=r.concat(o)}),r}})}function rr(t){return t._queryParams.loadsAllData()&&!t._queryParams.isDefault()?new(xx())(t._repo,t._path):t}function Px(t,e){for(let n=0;n<e.length;++n){const i=e[n];if(!i._queryParams.loadsAllData()){const r=yo(i),s=t.queryToTagMap.get(r);t.queryToTagMap.delete(r),t.tagToQueryMap.delete(s)}}}function Mx(){return Ix++}function Dx(t,e,n){const i=e._path,r=kr(t,e),s=Lm(t,n),o=t.listenProvider_.startListening(rr(e),r,s.hashFn,s.onComplete),a=t.syncPointTree_.subtree(i);if(r)S(!An(a.value),"If we're adding a query, it shouldn't be shadowed");else{const l=a.fold((c,u,f)=>{if(!J(c)&&u&&An(u))return[vo(u).query];{let d=[];return u&&(d=d.concat(Am(u).map(p=>p.query))),ot(f,(p,g)=>{d=d.concat(g)}),d}});for(let c=0;c<l.length;++c){const u=l[c];t.listenProvider_.stopListening(rr(u),kr(t,u))}}return o}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class pc{constructor(e="",n=null,i={children:{},childCount:0}){this.name=e,this.parent=n,this.node=i}}function mc(t,e){let n=e instanceof pe?e:new pe(e),i=t,r=ee(n);for(;r!==null;){const s=Ii(i.node.children,r)||{children:{},childCount:0};i=new pc(r,i,s),n=ye(n),r=ee(n)}return i}function Bi(t){return t.node.value}function $m(t,e){t.node.value=e,Wa(t)}function Bm(t){return t.node.childCount>0}function Hx(t){return Bi(t)===void 0&&!Bm(t)}function bo(t,e){ot(t.node.children,(n,i)=>{e(new pc(n,t,i))})}function Hm(t,e,n,i){n&&!i&&e(t),bo(t,r=>{Hm(r,e,!0,i)}),n&&i&&e(t)}function jx(t,e,n){let i=n?t:t.parent;for(;i!==null;){if(e(i))return!0;i=i.parent}return!1}function jr(t){return new pe(t.parent===null?t.name:jr(t.parent)+"/"+t.name)}function Wa(t){t.parent!==null&&Ux(t.parent,t.name,t)}function Ux(t,e,n){const i=Hx(n),r=nn(t.node.children,e);i&&r?(delete t.node.children[e],t.node.childCount--,Wa(t)):!i&&!r&&(t.node.children[e]=n.node,t.node.childCount++,Wa(t))}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Zx="repo_interrupt",eI=25;class tI{constructor(e,n,i,r){this.repoInfo_=e,this.forceRestClient_=n,this.authTokenProvider_=i,this.appCheckProvider_=r,this.dataUpdateCount=0,this.statsListener_=null,this.eventQueue_=new Qx,this.nextWriteId_=1,this.interceptServerDataCallback_=null,this.onDisconnect_=Ds(),this.transactionQueueTree_=new pc,this.persistentConnection_=null,this.key=this.repoInfo_.toURLString()}toString(){return(this.repoInfo_.secure?"https://":"http://")+this.repoInfo_.host}}function nI(t,e,n){if(t.stats_=Kl(t.repoInfo_),t.forceRestClient_||ME())t.server_=new Ms(t.repoInfo_,(i,r,s,o)=>{Lf(t,i,r,s,o)},t.authTokenProvider_,t.appCheckProvider_),setTimeout(()=>Ff(t,!0),0);else{if(typeof n<"u"&&n!==null){if(typeof n!="object")throw new Error("Only objects are supported for option databaseAuthVariableOverride");try{De(n)}catch(i){throw new Error("Invalid authOverride provided: "+i)}}t.persistentConnection_=new qt(t.repoInfo_,e,(i,r,s,o)=>{Lf(t,i,r,s,o)},i=>{Ff(t,i)},i=>{rI(t,i)},t.authTokenProvider_,t.appCheckProvider_,n),t.server_=t.persistentConnection_}t.authTokenProvider_.addTokenChangeListener(i=>{t.server_.refreshAuthToken(i)}),t.appCheckProvider_.addTokenChangeListener(i=>{t.server_.refreshAppCheckToken(i.token)}),t.statsReporter_=BE(t.repoInfo_,()=>new FC(t.stats_,t.server_)),t.infoData_=new OC,t.infoSyncTree_=new Mf({startListening:(i,r,s,o)=>{let a=[];const l=t.infoData_.getNode(i._path);return l.isEmpty()||(a=Br(t.infoSyncTree_,i._path,l),setTimeout(()=>{o("ok")},0)),a},stopListening:()=>{}}),vc(t,"connected",!1),t.serverSyncTree_=new Mf({startListening:(i,r,s,o)=>(t.server_.listen(i,s,r,(a,l)=>{const c=o(a,l);Ht(t.eventQueue_,i._path,c)}),[]),stopListening:(i,r)=>{t.server_.unlisten(i,r)}})}function iI(t){const n=t.infoData_.getNode(new pe(".info/serverTimeOffset")).val()||0;return new Date().getTime()+n}function _c(t){return Lx({timestamp:iI(t)})}function Lf(t,e,n,i,r){t.dataUpdateCount++;const s=new pe(e);n=t.interceptServerDataCallback_?t.interceptServerDataCallback_(e,n):n;let o=[];if(r)if(i){const l=Ts(n,c=>Ue(c));o=kx(t.serverSyncTree_,s,l,r)}else{const l=Ue(n);o=Pm(t.serverSyncTree_,s,l,r)}else if(i){const l=Ts(n,c=>Ue(c));o=Tx(t.serverSyncTree_,s,l)}else{const l=Ue(n);o=Br(t.serverSyncTree_,s,l)}let a=s;o.length>0&&(a=Eo(t,s)),Ht(t.eventQueue_,a,o)}function Ff(t,e){vc(t,"connected",e),e===!1&&aI(t)}function rI(t,e){ot(e,(n,i)=>{vc(t,n,i)})}function vc(t,e,n){const i=new pe("/.info/"+e),r=Ue(n);t.infoData_.updateSnapshot(i,r);const s=Br(t.infoSyncTree_,i,r);Ht(t.eventQueue_,i,s)}function Vm(t){return t.nextWriteId_++}function sI(t,e,n){const i=Rx(t.serverSyncTree_,e);return i!=null?Promise.resolve(i):t.server_.get(e).then(r=>{const s=Ue(r).withIndex(e._queryParams.getIndex());Nx(t.serverSyncTree_,e,n,!0);let o;if(e._queryParams.loadsAllData())o=Br(t.serverSyncTree_,e._path,s);else{const a=kr(t.serverSyncTree_,e);o=Pm(t.serverSyncTree_,e._path,s,a)}return Ht(t.eventQueue_,e._path,o),Om(t.serverSyncTree_,e,n,null,!0),s},r=>(wo(t,"get for query "+De(e)+" failed: "+r),Promise.reject(new Error(r))))}function oI(t,e,n,i,r){wo(t,"set",{path:e.toString(),value:n,priority:i});const s=_c(t),o=Ue(n,i),a=ac(t.serverSyncTree_,e),l=Fm(o,a,s),c=Vm(t),u=Rm(t.serverSyncTree_,e,l,c,!0);Wm(t.eventQueue_,u),t.server_.put(e.toString(),o.val(!0),(d,p)=>{const g=d==="ok";g||st("set at "+e+" failed: "+d);const b=Wn(t.serverSyncTree_,c,!g);Ht(t.eventQueue_,e,b),cI(t,r,d,p)});const f=Qm(t,e);Eo(t,f),Ht(t.eventQueue_,f,[])}function aI(t){wo(t,"onDisconnectEvents");const e=_c(t),n=Ds();Ba(t.onDisconnect_,se(),(r,s)=>{const o=Bx(r,s,t.serverSyncTree_,e);mm(n,r,o)});let i=[];Ba(n,se(),(r,s)=>{i=i.concat(Br(t.serverSyncTree_,r,s));const o=Qm(t,r);Eo(t,o)}),t.onDisconnect_=Ds(),Ht(t.eventQueue_,se(),i)}function lI(t){t.persistentConnection_&&t.persistentConnection_.interrupt(Zx)}function wo(t,...e){let n="";t.persistentConnection_&&(n=t.persistentConnection_.id+":"),Ke(n,...e)}function cI(t,e,n,i){e&&$i(()=>{if(n==="ok")e(null);else{const r=(n||"error").toUpperCase();let s=r;i&&(s+=": "+i);const o=new Error(s);o.code=r,e(o)}})}function qm(t,e,n){return ac(t.serverSyncTree_,e,n)||z.EMPTY_NODE}function yc(t,e=t.transactionQueueTree_){if(e||Co(t,e),Bi(e)){const n=Ym(t,e);S(n.length>0,"Sending zero length transaction queue"),n.every(r=>r.status===0)&&uI(t,jr(e),n)}else Bm(e)&&bo(e,n=>{yc(t,n)})}function uI(t,e,n){const i=n.map(c=>c.currentWriteId),r=qm(t,e,i);let s=r;const o=r.hash();for(let c=0;c<n.length;c++){const u=n[c];S(u.status===0,"tryToSendTransactionQueue_: items in queue should all be run."),u.status=1,u.retryCount++;const f=et(e,u.path);s=s.updateChild(f,u.currentOutputSnapshotRaw)}const a=s.val(!0),l=e;t.server_.put(l.toString(),a,c=>{wo(t,"transaction put response",{path:l.toString(),status:c});let u=[];if(c==="ok"){const f=[];for(let d=0;d<n.length;d++)n[d].status=2,u=u.concat(Wn(t.serverSyncTree_,n[d].currentWriteId)),n[d].onComplete&&f.push(()=>n[d].onComplete(null,!0,n[d].currentOutputSnapshotResolved)),n[d].unwatcher();Co(t,mc(t.transactionQueueTree_,e)),yc(t,t.transactionQueueTree_),Ht(t.eventQueue_,e,u);for(let d=0;d<f.length;d++)$i(f[d])}else{if(c==="datastale")for(let f=0;f<n.length;f++)n[f].status===3?n[f].status=4:n[f].status=0;else{st("transaction at "+l.toString()+" failed: "+c);for(let f=0;f<n.length;f++)n[f].status=4,n[f].abortReason=c}Eo(t,e)}},o)}function Eo(t,e){const n=Gm(t,e),i=jr(n),r=Ym(t,n);return fI(t,r,i),i}function fI(t,e,n){if(e.length===0)return;const i=[];let r=[];const o=e.filter(a=>a.status===0).map(a=>a.currentWriteId);for(let a=0;a<e.length;a++){const l=e[a],c=et(n,l.path);let u=!1,f;if(S(c!==null,"rerunTransactionsUnderNode_: relativePath should not be null."),l.status===4)u=!0,f=l.abortReason,r=r.concat(Wn(t.serverSyncTree_,l.currentWriteId,!0));else if(l.status===0)if(l.retryCount>=eI)u=!0,f="maxretry",r=r.concat(Wn(t.serverSyncTree_,l.currentWriteId,!0));else{const d=qm(t,l.path,o);l.currentInputSnapshot=d;const p=e[a].update(d.val());if(p!==void 0){gc("transaction failed: Data returned ",p,l.path);let g=Ue(p);typeof p=="object"&&p!=null&&nn(p,".priority")||(g=g.updatePriority(d.getPriority()));const I=l.currentWriteId,_=_c(t),w=Fm(g,d,_);l.currentOutputSnapshotRaw=g,l.currentOutputSnapshotResolved=w,l.currentWriteId=Vm(t),o.splice(o.indexOf(I),1),r=r.concat(Rm(t.serverSyncTree_,l.path,w,l.currentWriteId,l.applyLocally)),r=r.concat(Wn(t.serverSyncTree_,I,!0))}else u=!0,f="nodata",r=r.concat(Wn(t.serverSyncTree_,l.currentWriteId,!0))}Ht(t.eventQueue_,n,r),r=[],u&&(e[a].status=2,function(d){setTimeout(d,Math.floor(0))}(e[a].unwatcher),e[a].onComplete&&(f==="nodata"?i.push(()=>e[a].onComplete(null,!1,e[a].currentInputSnapshot)):i.push(()=>e[a].onComplete(new Error(f),!1,null))))}Co(t,t.transactionQueueTree_);for(let a=0;a<i.length;a++)$i(i[a]);yc(t,t.transactionQueueTree_)}function Gm(t,e){let n,i=t.transactionQueueTree_;for(n=ee(e);n!==null&&Bi(i)===void 0;)i=mc(i,n),e=ye(e),n=ee(e);return i}function Ym(t,e){const n=[];return Km(t,e,n),n.sort((i,r)=>i.order-r.order),n}function Km(t,e,n){const i=Bi(e);if(i)for(let r=0;r<i.length;r++)n.push(i[r]);bo(e,r=>{Km(t,r,n)})}function Co(t,e){const n=Bi(e);if(n){let i=0;for(let r=0;r<n.length;r++)n[r].status!==2&&(n[i]=n[r],i++);n.length=i,$m(e,n.length>0?n:void 0)}bo(e,i=>{Co(t,i)})}function Qm(t,e){const n=jr(Gm(t,e)),i=mc(t.transactionQueueTree_,e);return jx(i,r=>{Jo(t,r)}),Jo(t,i),Hm(i,r=>{Jo(t,r)}),n}function Jo(t,e){const n=Bi(e);if(n){const i=[];let r=[],s=-1;for(let o=0;o<n.length;o++)n[o].status===3||(n[o].status===1?(S(s===o-1,"All SENT items should be at beginning of queue."),s=o,n[o].status=3,n[o].abortReason="set"):(S(n[o].status===0,"Unexpected transaction status in abort"),n[o].unwatcher(),r=r.concat(Wn(t.serverSyncTree_,n[o].currentWriteId,!0)),n[o].onComplete&&i.push(n[o].onComplete.bind(null,new Error("set"),!1,null))));s===-1?$m(e,void 0):n.length=s+1,Ht(t.eventQueue_,jr(e),r);for(let o=0;o<i.length;o++)$i(i[o])}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function dI(t){let e="";const n=t.split("/");for(let i=0;i<n.length;i++)if(n[i].length>0){let r=n[i];try{r=decodeURIComponent(r.replace(/\+/g," "))}catch{}e+="/"+r}return e}function hI(t){const e={};t.charAt(0)==="?"&&(t=t.substring(1));for(const n of t.split("&")){if(n.length===0)continue;const i=n.split("=");i.length===2?e[decodeURIComponent(i[0])]=decodeURIComponent(i[1]):st(`Invalid query segment '${n}' in query '${t}'`)}return e}const $f=function(t,e){const n=pI(t),i=n.namespace;n.domain==="firebase.com"&&Zt(n.host+" is no longer supported. Please use <YOUR FIREBASE>.firebaseio.com instead"),(!i||i==="undefined")&&n.domain!=="localhost"&&Zt("Cannot parse Firebase url. Please use https://<YOUR FIREBASE>.firebaseio.com"),n.secure||IE();const r=n.scheme==="ws"||n.scheme==="wss";return{repoInfo:new Kp(n.host,n.secure,i,r,e,"",i!==n.subdomain),path:new pe(n.pathString)}},pI=function(t){let e="",n="",i="",r="",s="",o=!0,a="https",l=443;if(typeof t=="string"){let c=t.indexOf("//");c>=0&&(a=t.substring(0,c-1),t=t.substring(c+2));let u=t.indexOf("/");u===-1&&(u=t.length);let f=t.indexOf("?");f===-1&&(f=t.length),e=t.substring(0,Math.min(u,f)),u<f&&(r=dI(t.substring(u,f)));const d=hI(t.substring(Math.min(t.length,f)));c=e.indexOf(":"),c>=0?(o=a==="https"||a==="wss",l=parseInt(e.substring(c+1),10)):c=e.length;const p=e.slice(0,c);if(p.toLowerCase()==="localhost")n="localhost";else if(p.split(".").length<=2)n=p;else{const g=e.indexOf(".");i=e.substring(0,g).toLowerCase(),n=e.substring(g+1),s=i}"ns"in d&&(s=d.ns)}return{host:e,port:l,domain:n,subdomain:i,secure:o,scheme:a,pathString:r,namespace:s}};/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class mI{constructor(e,n,i,r){this.eventType=e,this.eventRegistration=n,this.snapshot=i,this.prevName=r}getPath(){const e=this.snapshot.ref;return this.eventType==="value"?e._path:e.parent._path}getEventType(){return this.eventType}getEventRunner(){return this.eventRegistration.getEventRunner(this)}toString(){return this.getPath().toString()+":"+this.eventType+":"+De(this.snapshot.exportVal())}}class gI{constructor(e,n,i){this.eventRegistration=e,this.error=n,this.path=i}getPath(){return this.path}getEventType(){return"cancel"}getEventRunner(){return this.eventRegistration.getEventRunner(this)}toString(){return this.path.toString()+":cancel"}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const bI="FIREBASE_DATABASE_EMULATOR_HOST",Va={};let wI=!1;function EI(t,e,n,i){t.repoInfo_=new Kp(`${e}:${n}`,!1,t.repoInfo_.namespace,t.repoInfo_.webSocketOnly,t.repoInfo_.nodeAdmin,t.repoInfo_.persistenceKey,t.repoInfo_.includeNamespaceInQueryParams),i&&(t.authTokenProvider_=i)}function CI(t,e,n,i,r){let s=i||t.options.databaseURL;s===void 0&&(t.options.projectId||Zt("Can't determine Firebase Database URL. Be sure to include  a Project ID when calling firebase.initializeApp()."),Ke("Using default host for project ",t.options.projectId),s=`${t.options.projectId}-default-rtdb.firebaseio.com`);let o=$f(s,r),a=o.repoInfo,l,c;typeof process<"u"&&process.env&&(c=process.env[bI]),c?(l=!0,s=`http://${c}?ns=${a.namespace}`,o=$f(s,r),a=o.repoInfo):l=!o.repoInfo.secure;const u=r&&l?new bi(bi.OWNER):new LE(t.name,t.options,e);Kx("Invalid Firebase Database URL",o),J(o.path)||Zt("Database URL must point to the root of a Firebase Database (not including a child path).");const f=II(a,t,u,new DE(t.name,n));return new TI(f,t)}function xI(t,e){const n=Va[e];(!n||n[t.key]!==t)&&Zt(`Database ${e}(${t.repoInfo_}) has already been deleted.`),lI(t),delete n[t.key]}function II(t,e,n,i){let r=Va[e.name];r||(r={},Va[e.name]=r);let s=r[t.toURLString()];return s&&Zt("Database initialized multiple times. Please make sure the format of the database URL matches with each database() call."),s=new tI(t,wI,n,i),r[t.toURLString()]=s,s}class TI{constructor(e,n){this._repoInternal=e,this.app=n,this.type="database",this._instanceStarted=!1}get _repo(){return this._instanceStarted||(nI(this._repoInternal,this.app.options.appId,this.app.options.databaseAuthVariableOverride),this._instanceStarted=!0),this._repoInternal}get _root(){return this._rootInternal||(this._rootInternal=new rn(this._repo,se())),this._rootInternal}_delete(){return this._rootInternal!==null&&(xI(this._repo,this.app.name),this._repoInternal=null,this._rootInternal=null),Promise.resolve()}_checkNotDeleted(e){this._rootInternal===null&&Zt("Cannot call "+e+" on a deleted database.")}}function Ec(t=lp(),e){const n=Dr(t,"database").getImmediate({identifier:e}),i=D0("database");if(i){const[r,s]=i.split(":");SI(n,r,parseInt(s,10))}return n}function SI(t,e,n,i={}){t=kn(t),t._checkNotDeleted("useEmulator"),t._instanceStarted&&Zt("Cannot call useEmulator() after instance has already been initialized.");const r=t._repoInternal;let s;if(r.repoInfo_.nodeAdmin)i.mockUserToken&&Zt('mockUserToken is not supported by the Admin SDK. For client access with mock users, please use the "firebase" package instead of "firebase-admin".'),s=new bi(bi.OWNER);else if(i.mockUserToken){const o=typeof i.mockUserToken=="string"?i.mockUserToken:F0(i.mockUserToken,t.app.options.projectId);s=new bi(o)}EI(r,e,n,s)}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
